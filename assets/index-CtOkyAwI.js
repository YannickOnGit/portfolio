...
`;class Se{constructor(v){var F;this.props=v||{},this.uniforms=(F=this.props.material)==null?void 0:F.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new Mv,this.camera=new cu,this.uniforms&&(this.material=new Jo(this.props.material),this.geometry=new Fs(2,2),this.plane=new di(this.geometry,this.material),this.scene.add(this.plane))}update(){ue.renderer.setRenderTarget(this.props.output||null),ue.renderer.render(this.scene,this.camera),ue.renderer.setRenderTarget(null)}}class Je extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:K,uniforms:{boundarySpace:{value:v.cellScale},px:{value:v.cellScale},fboSize:{value:v.fboSize},velocity:{value:v.src.texture},dt:{value:v.dt},isBFECC:{value:!0}}},output:v.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){const v=new Ci,F=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);v.setAttribute("position",new Ri(F,3));const Z=new Jo({vertexShader:ve,fragmentShader:K,uniforms:this.uniforms});this.line=new nE(v,Z),this.scene.add(this.line)}update({dt:v,isBounce:F,BFECC:Z}){this.uniforms.dt.value=v,this.line.visible=F,this.uniforms.isBFECC.value=Z,super.update()}}class Ke extends Se{constructor(v){super({output:v.dst}),this.init(v)}init(v){super.init();const F=new Fs(1,1),Z=new Jo({vertexShader:P,fragmentShader:Ne,blending:ch,depthWrite:!1,uniforms:{px:{value:v.cellScale},force:{value:new ot(0,0)},center:{value:new ot(0,0)},scale:{value:new ot(v.cursor_size,v.cursor_size)}}});this.mouse=new di(F,Z),this.scene.add(this.mouse)}update(v){const F=I.diff.x/2*v.mouse_force,Z=I.diff.y/2*v.mouse_force,le=v.cursor_size*v.cellScale.x,ae=v.cursor_size*v.cellScale.y,we=Math.min(Math.max(I.coords.x,-1+le+v.cellScale.x*2),1-le-v.cellScale.x*2),Ce=Math.min(Math.max(I.coords.y,-1+ae+v.cellScale.y*2),1-ae-v.cellScale.y*2),Xe=this.mouse.material.uniforms;Xe.force.value.set(F,Z),Xe.center.value.set(we,Ce),Xe.scale.value.set(v.cursor_size,v.cursor_size),super.update()}}class $e extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:be,uniforms:{boundarySpace:{value:v.boundarySpace},velocity:{value:v.src.texture},velocity_new:{value:v.dst_.texture},v:{value:v.viscous},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst,output0:v.dst_,output1:v.dst}),this.init()}update({viscous:v,iterations:F,dt:Z}){let le,ae;this.uniforms.v.value=v;for(let we=0;we<F;we++)we%2===0?(le=this.props.output0,ae=this.props.output1):(le=this.props.output1,ae=this.props.output0),this.uniforms.velocity_new.value=le.texture,this.props.output=ae,this.uniforms.dt.value=Z,super.update();return ae}}class qt extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:ye,uniforms:{boundarySpace:{value:v.boundarySpace},velocity:{value:v.src.texture},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst}),this.init()}update({vel:v}){this.uniforms.velocity.value=v.texture,super.update()}}class ht extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:Ye,uniforms:{boundarySpace:{value:v.boundarySpace},pressure:{value:v.dst_.texture},divergence:{value:v.src.texture},px:{value:v.cellScale}}},output:v.dst,output0:v.dst_,output1:v.dst}),this.init()}update({iterations:v}){let F,Z;for(let le=0;le<v;le++)le%2===0?(F=this.props.output0,Z=this.props.output1):(F=this.props.output1,Z=this.props.output0),this.uniforms.pressure.value=F.texture,this.props.output=Z,super.update();return Z}}class xt extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:ee,uniforms:{boundarySpace:{value:v.boundarySpace},pressure:{value:v.src_p.texture},velocity:{value:v.src_v.texture},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst}),this.init()}update({vel:v,pressure:F}){this.uniforms.velocity.value=v.texture,this.uniforms.pressure.value=F.texture,super.update()}}class Ct{constructor(v){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...v},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new ot,this.cellScale=new ot,this.boundarySpace=new ot,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?Xi:Ti}createAllFBO(){const F={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:dn,magFilter:dn,wrapS:ei,wrapT:ei};for(let Z in this.fbos)this.fbos[Z]=new Ai(this.fboSize.x,this.fboSize.y,F)}createShaderPass(){this.advection=new Je({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new Ke({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new $e({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new qt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new ht({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new xt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){const v=Math.max(1,Math.round(this.options.resolution*ue.width)),F=Math.max(1,Math.round(this.options.resolution*ue.height)),Z=1/v,le=1/F;this.cellScale.set(Z,le),this.fboSize.set(v,F)}resize(){this.calcSize();for(let v in this.fbos)this.fbos[v].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let v=this.fbos.vel_1;this.options.isViscous&&(v=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:v});const F=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:v,pressure:F})}}class rt{constructor(){this.init()}init(){this.simulation=new Ct,this.scene=new Mv,this.camera=new cu,this.output=new di(new Fs(2,2),new Jo({vertexShader:de,fragmentShader:pe,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new ot},palette:{value:V},bgColor:{value:te}}})),this.scene.add(this.output)}addScene(v){this.scene.add(v)}resize(){this.simulation.resize()}render(){ue.renderer.setRenderTarget(null),ue.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class St{constructor(v){this.props=v,ue.init(v.$wrapper),I.init(v.$wrapper),I.autoIntensity=v.autoIntensity,I.takeoverDuration=v.takeoverDuration,this.lastUserInteraction=performance.now(),I.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new H(I,this,{enabled:v.autoDemo,speed:v.autoSpeed,resumeDelay:v.autoResumeDelay,rampDuration:v.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener("resize",this._resize),this._onVisibility=()=>{document.hidden?this.pause():A.current&&this.start()},document.addEventListener("visibilitychange",this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(ue.renderer.domElement),this.output=new rt}resize(){ue.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),I.update(),ue.update(),this.output.update()}loop(){this.running&&(this.render(),G.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,G.current&&(cancelAnimationFrame(G.current),G.current=null)}dispose(){try{if(window.removeEventListener("resize",this._resize),document.removeEventListener("visibilitychange",this._onVisibility),I.dispose(),ue.renderer){const v=ue.renderer.domElement;v&&v.parentNode&&v.parentNode.removeChild(v),ue.renderer.dispose()}}catch{}}}const j=U.current;j.style.position=j.style.position||"relative",j.style.overflow=j.style.overflow||"hidden";const jt=new St({$wrapper:j,autoDemo:b,autoSpeed:T,autoIntensity:C,takeoverDuration:M,autoResumeDelay:S,autoRampDuration:D});L.current=jt,(()=>{var F;if(!L.current)return;const N=(F=L.current.output)==null?void 0:F.simulation;if(!N)return;const v=N.options.resolution;Object.assign(N.options,{mouse_force:r,cursor_size:e,isViscous:i,viscous:s,iterations_viscous:l,iterations_poisson:c,dt:f,BFECC:p,resolution:m,isBounce:h}),m!==v&&N.resize()})(),jt.start();const bt=new IntersectionObserver(N=>{const v=N[0],F=v.isIntersecting&&v.intersectionRatio>0;A.current=F,L.current&&(F&&!document.hidden?L.current.start():L.current.pause())},{threshold:[0,.01,.1]});bt.observe(j),k.current=bt;const Ge=new ResizeObserver(()=>{L.current&&(O.current&&cancelAnimationFrame(O.current),O.current=requestAnimationFrame(()=>{L.current&&L.current.resize()}))});return Ge.observe(j),B.current=Ge,()=>{if(G.current&&cancelAnimationFrame(G.current),B.current)try{B.current.disconnect()}catch{}if(k.current)try{k.current.disconnect()}catch{}L.current&&L.current.dispose(),L.current=null}},[p,e,f,h,i,c,l,r,m,s,g,b,T,C,M,S,D]),me.useEffect(()=>{var se;const he=L.current;if(!he)return;const V=(se=he.output)==null?void 0:se.simulation;if(!V)return;const te=V.options.resolution;Object.assign(V.options,{mouse_force:r,cursor_size:e,isViscous:i,viscous:s,iterations_viscous:l,iterations_poisson:c,dt:f,BFECC:p,resolution:m,isBounce:h}),he.autoDriver&&(he.autoDriver.enabled=b,he.autoDriver.speed=T,he.autoDriver.resumeDelay=S,he.autoDriver.rampDurationMs=D*1e3,he.autoDriver.mouse&&(he.autoDriver.mouse.autoIntensity=C,he.autoDriver.mouse.takeoverDuration=M)),m!==te&&V.resize()},[r,e,i,s,l,c,f,p,m,h,b,T,C,M,S,D]),y.jsx("div",{ref:U,className:`liquid-ether-container ${_||""}`,style:x})}const Lr=({name:r="",size:e=24,color:i="currentColor",strokeColor:s="",className:l=""})=>y.jsx("svg",{className:l,width:e,height:e,fill:i,stroke:s||"currentColor",children:y.jsx("use",{href:`/portfolio/icon-sprite.svg#${r}`})}),lw=({toggleMenu:r})=>y.jsxs("header",{className:"p-2 border-b border-zinc-800 text-white h-14 flex justify-between px-4 w-full","aria-label":"Main navigation",children:[y.jsx("div",{className:"flex flex-1 items-center",children:y.jsxs("div",{className:"flex items-center space-x-2",children:[y.jsx("button",{onClick:r,"aria-label":"Toggle menu",className:"md:hidden",children:y.jsx(Lr,{name:"mobile-menu",size:16,className:"stroke-gray-600"})}),y.jsx("h5",{children:"Yannick Boulanger / Product Design"})]})}),y.jsx("div",{className:"flex flex-1",children:y.jsxs("div",{className:"flex items-center space-x-2 mx-auto",children:[y.jsx("i",{className:"",children:y.jsx("svg",{width:"24",height:"24",viewBox:"0 2 24 24",xmlns:"http://www.w3.org/2000/svg",fill:"orange",children:y.jsx("path",{d:"M12 2.5L14.9 8.6L21.5 9.4L16.75 13.9L18.1 20.5L12 17.2L5.9 20.5L7.25 13.9L2.5 9.4L9.1 8.6L12 2.5Z"})})}),y.jsx("p",{children:"Open to New Opportunities"}),y.jsx("button",{className:" p-1.5 pb-1 px-3 ml-3 rounded-lg border border-gray-600 transition-all duration-500 hover:border-purple-400 hover:bg-purple-900 hover:text-white",children:"Get in touch!"})]})}),y.jsx("div",{className:"flex flex-1 space-x-2 justify-end",children:y.jsx("a",{href:"javascript:;",className:"p-1 rounded-lg items-center border border-gray-600 justify-center transition-all duration-500  hover:border-blue-400 hover:bg-blue-900",children:y.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"28",height:"28",viewBox:"0 0 72 72",fill:"none",children:y.jsx("path",{d:"M24.7612 55.999V28.3354H15.5433V55.999H24.7621H24.7612ZM20.1542 24.5591C23.3679 24.5591 25.3687 22.4348 25.3687 19.7801C25.3086 17.065 23.3679 15 20.2153 15C17.0605 15 15 17.065 15 19.7799C15 22.4346 17.0001 24.5588 20.0938 24.5588H20.1534L20.1542 24.5591ZM29.8633 55.999H39.0805V40.5521C39.0805 39.7264 39.1406 38.8985 39.3841 38.3088C40.0502 36.6562 41.5668 34.9455 44.1138 34.9455C47.4484 34.9455 48.7831 37.4821 48.7831 41.2014V55.999H58V40.1376C58 31.6408 53.4532 27.6869 47.3887 27.6869C42.4167 27.6869 40.233 30.4589 39.0198 32.347H39.0812V28.3364H29.8638C29.9841 30.9316 29.8631 56 29.8631 56L29.8633 55.999Z",fill:"#fff"})})})})]}),cw=()=>y.jsx(y.Fragment,{children:y.jsx("footer",{className:" text-white border-t border-t-stone-800 h-12 flex flex-row w-full","aria-label":"Main navigation",children:y.jsx("div",{className:"flex-none content-center",children:y.jsx("a",{href:"#",className:" px-0 md:px-4 flex flex-row  justify-center md:justify-start","aria-label":"Go to homepage",children:y.jsx("h1",{className:"pl-2 text-xs font-light content-center hidden md:inline-block",children:"Copyright 2025 Yannick Boulanger"})})})})}),uw=()=>{const r=Ra(),[e,i]=me.useState(!1),[s,l]=me.useState(!1);me.useEffect(()=>{i(r.pathname.startsWith("/Case")),l(r.pathname.startsWith("/Portfolio"))},[r.pathname]);const c="text-md text-stone-100 flex flex-row px-0 py-2 pl-6 pr-4  hover:bg-stone-800 active:bg-sky-700 items-center justify-center justify-start",f=p=>r.pathname===p?"is-active":"";return y.jsx("div",{className:"grow border-r border-zinc-800 pt-4",children:y.jsx("nav",{"aria-label":"Primary Navigation",children:y.jsxs("ul",{className:"list-none mt-4",children:[y.jsx("li",{children:y.jsxs(Or,{to:"/","aria-label":"Go to Home",className:`${c} ${f("/")}`,children:[y.jsx(Lr,{name:"home",size:20,className:"mr-2 stroke-gray-600"}),y.jsx("span",{className:"text-xl font-normal",children:"Hero"})]})}),y.jsxs("li",{children:[y.jsxs("button",{onClick:()=>i(p=>!p),"aria-expanded":e,"aria-controls":"cases-menu",type:"button",className:`${c} font-medium group w-full`,children:[y.jsx(Lr,{name:"cases",size:20,className:"mr-2 stroke-gray-600"}),y.jsx("span",{className:"text-xl font-normal",children:"Cases"}),y.jsx(Lr,{name:"chevron-down",size:20,className:`ml-auto stroke-gray-600 transform transition-transform duration-300 ${e?"rotate-180":""}`})]}),e&&y.jsx("ul",{id:"cases-menu",className:"ml-4 mt-1 space-y-1 list-none",children:["Case01","Case02","Case03"].map(p=>y.jsx("li",{children:y.jsx(Or,{to:`/${p}`,className:`${c} ${f(`/${p}`)}`,"aria-label":`Go to ${p}`,children:y.jsx("span",{className:"text-xl font-normal",children:p.replace("Case","Case ")})})},p))})]}),y.jsx("li",{children:y.jsxs(Or,{to:"/Resume",className:`${c} ${f("/Resume")}`,"aria-label":"Go to Resume",children:[y.jsx(Lr,{name:"resume",size:20,className:"mr-2 stroke-gray-600"}),y.jsx("span",{className:"text-xl font-normal",children:"Summary"})]})}),y.jsx("li",{children:y.jsxs(Or,{to:"/Certification",className:`${c} ${f("/Certification")}`,"aria-label":"Go to Certifications",children:[y.jsx(Lr,{name:"certification",size:20,className:"mr-2 stroke-gray-600"}),y.jsx("span",{className:"text-xl font-normal",children:"Certification"})]})})]})})})};function fw(){return y.jsx(y.Fragment,{children:y.jsxs("div",{className:"w-full py-12",children:[y.jsxs("div",{className:"mb-16 max-w-screen-lg mx-auto text-white",children:[y.jsx("h2",{className:"mt-12 text-4xl text-teal-300 pb-16",children:"Yannick Boulanger"}),y.jsx("h1",{className:"uppercase font-bold text-7xl leading-none",children:"Product Designer"}),y.jsx("h1",{className:"mb-16 uppercase font-light text-7xl leading-none",children:"Building for Complex Human Application"}),y.jsxs("div",{className:"flex flex-wrap gap-12",children:[y.jsxs("div",{className:"flex-1",children:[y.jsx("h3",{className:"",children:"Enterprise SaaS Delivery"}),y.jsx("p",{className:"mt-4 text-xl text-gray-400 max-w-5xl leading-snug",children:"I envision complex SaaS products from discovery through delivery and ground product strategy in user research and real-world workflows."}),y.jsx("h3",{className:"mt-6",children:"Cross-Functional Collaboration"}),y.jsx("p",{className:"mt-4 text-xl text-gray-400 max-w-5xl  leading-snug",children:"I collaborate with Product and Engineering to align product vision and implementation, enabling the simplification of complex systems into scalable, intuitive experiences."})]}),y.jsxs("div",{className:"flex-1",children:[y.jsx("h3",{className:"",children:"Structured, Usable Systems"}),y.jsx("p",{className:"mt-4 text-xl text-gray-400 max-w-5xl leading-snug",children:"I prioritize information architecture, consistency, and usability over visual polish, ensuring highly technical environments remain accessible, secure, and reliable."}),y.jsx("h3",{className:"mt-6",children:"Evidence-Based Practice"}),y.jsx("p",{className:"mt-4 text-xl text-gray-400 max-w-5xl leading-snug",children:"I take an iterative, evidence-based approach, guiding design decisions with data and measuring impact through meaningful user and business outcomes."})]})]})]}),y.jsxs("div",{className:"mb-16 max-w-screen-lg mx-auto",children:[y.jsx("h3",{className:"text-white text-3xl font-light uppercase mb-6",children:"UX Case Studies"}),y.jsxs("div",{className:"flex flex-wrap gap-6",children:[y.jsxs("div",{className:"bg-zinc-900 flex-1 min-w-[220px] rounded-lg shadow hover:shadow-lg transition overflow-hidden",children:[y.jsx("div",{className:"w-full aspect-square bg-zinc-800 flex items-center justify-center text-gray-500 text-sm",children:"Image"}),y.jsxs("div",{className:"p-6 bg-teal-800",children:[y.jsx("h4",{className:"text-white pb-2",children:"SD-WAN Orchestrator"}),y.jsx("p",{className:"text-gray-300 text-sm",children:"Streamlining multi-tenant workflows for an SD-WAN platform"})]})]}),y.jsxs("div",{className:"bg-zinc-900 flex-1 min-w-[220px] rounded-lg shadow hover:shadow-lg transition overflow-hidden",children:[y.jsx("div",{className:"bg-[url('/src/assets/VS-CallerUI-001.png')] bg-cover bg-center w-full aspect-square bg-zinc-800 flex items-center justify-center text-gray-500 text-sm",children:"Image"}),y.jsxs("div",{className:"p-6 bg-indigo-800",children:[y.jsx("h4",{className:"text-white pb-2",children:"CRM Caller UI"}),y.jsx("p",{className:"text-gray-300 text-sm",children:"Redesigned CRM caller UI → boosted efficiency & 30% YoY growth"})]})]}),y.jsxs("div",{className:"bg-zinc-900 flex-1 min-w-[220px] rounded-lg shadow hover:shadow-lg transition overflow-hidden",children:[y.jsx("div",{className:"w-full aspect-square bg-zinc-800 flex items-center justify-center text-gray-500 text-sm",children:"Image"}),y.jsxs("div",{className:"p-6 bg-rose-800",children:[y.jsx("h4",{className:"text-white pb-2",children:"SaaS Design System"}),y.jsx("p",{className:"text-gray-300 text-sm",children:"Built a scalable design system powering SaaS product growth"})]})]})]})]}),y.jsxs("div",{className:"text-white max-w-screen-lg mx-auto flex flex-wrap gap-6 mb-16",children:[y.jsx("h3",{className:"text-white text-3xl font-light uppercase",children:"Summary"}),y.jsx("p",{className:"text-xl text-gray-400 max-w-5xl",children:"Senior Product Designer with 15+ years of experience leading complex B2B SaaS and enterprise platforms from concept to delivery. I combine strategic thinking, technical depth, and creative problem-solving to simplify complex systems, including cloud-native SD-WAN and scalable sales engagement CRM platforms."}),y.jsx("p",{className:"text-xl text-gray-400 max-w-5xl mb-2",children:"I’ve led large-scale UX redesigns that drive measurable revenue growth, operational efficiency, and platform scalability. I align business vision, system architecture, and human-centred design to deliver secure, intuitive, and resilient product experiences."}),y.jsxs("div",{className:"flex flex-wrap space-x-0.5 max-w-screen-lg mx-auto text-white w-full",children:[y.jsx("div",{className:"flex-1 p-6 bg-zinc-900  rounded-bl-lg rounded-tl-xl",children:y.jsxs("dl",{children:[y.jsx("dt",{className:"text-2xl pb-2",children:"Product Design"}),y.jsx("dd",{children:"Strategy, Vision & Agile Delivery"})]})}),y.jsx("div",{className:"flex-1 p-6 bg-zinc-900",children:y.jsxs("dl",{children:[y.jsx("dt",{className:"text-2xl pb-2",children:"UI/UX"}),y.jsx("dd",{children:"Workflow & Interaction Architecture"})]})}),y.jsx("div",{className:"flex-1 p-6 bg-zinc-900",children:y.jsxs("dl",{children:[y.jsx("dt",{className:"text-2xl pb-2",children:"SaaS/B2B"}),y.jsx("dd",{children:"Scalable Enterprise Platforms"})]})}),y.jsx("div",{className:"flex-1 p-6 bg-zinc-900 rounded-br-lg rounded-tr-xl",children:y.jsxs("dl",{children:[y.jsx("dt",{className:"text-2xl pb-2",children:"Front-End"}),y.jsx("dd",{children:"Implementation, Code & Accessibility"})]})})]})]}),y.jsxs("div",{className:"text-white max-w-screen-lg mx-auto flex flex-wrap gap-6 mb-24",children:[y.jsxs("div",{className:"flex-1 min-w-[250px rounded-lg shadow",children:[y.jsx("h3",{className:"text-white mb-6 uppercase",children:"Experience"}),y.jsxs("ul",{className:"list-none mb-6 text-gray-400",children:[y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-27 h-10 float-left font-bold text-gray-500",children:"2021 - 2025"})," Adaptiv Networks",y.jsx("br",{})," Senior Product Designer"]}),y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-27 h-10 float-left font-bold text-gray-500",children:"2013 - 2021"})," VanillaSoft",y.jsx("br",{})," Product Designer"]}),y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-27 h-10 float-left font-bold text-gray-500",children:"2010 - 2012"})," MD Financial Management",y.jsx("br",{}),"UX Designer"]})]}),y.jsx("h3",{className:"text-white mt-16 uppercase",children:"Language"}),y.jsxs("ul",{className:"list-none mt-4 text-gray-400",children:[y.jsxs("li",{className:"mb-2",children:["English ",y.jsx("em",{children:"(Fluent)"})]}),y.jsxs("li",{className:"mb-2",children:["French ",y.jsx("em",{children:"(Fluent)"})]})]})]}),y.jsxs("div",{className:"flex-1 min-w-[250px] rounded-lg shadow",children:[y.jsx("h3",{className:"text-white uppercase",children:"Certification"}),y.jsxs("ul",{className:"list-none mt-4  text-gray-400",children:[y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-14 float-left font-bold  text-gray-500",children:"2010"})," User-Centred Design"]}),y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-14 float-left font-bold  text-gray-500",children:"2019"})," Professional Scrum Master I (PSM I)"]}),y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-14 float-left font-bold  text-gray-500",children:"2021"})," Professional Scrum Master with UX (PSU)"]}),y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-14 float-left font-bold  text-gray-500",children:"2025"})," Enterprise Design Thinking Co-Creator, IBM"]}),y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-14 float-left font-bold  text-gray-500",children:"2025"})," Enterprise Design Thinking Practitioner, IBM"]}),y.jsxs("li",{className:"mb-2",children:[y.jsx("em",{className:"w-14 float-left font-bold  text-gray-500",children:"2025"})," Artificial Intelligence Fundamentals, IBM"]})]})]})]})]})})}function dw(){return y.jsx("h1",{className:"text-3xl font-bold",children:"About"})}const hw="/portfolio/assets/VS-Old-CallerUI-Dw1hW2WW.png",pw="/portfolio/assets/VS-CallerUI-001-B8ad10j0.png",va=({title:r,children:e})=>y.jsx("div",{className:"w-full",children:y.jsxs("div",{className:"max-w-screen-lg mx-auto px-6",children:[y.jsx("div",{children:y.jsx("h2",{className:" text-zinc-900 mb-4",children:r})}),y.jsx("div",{className:"pt-4 pb-9",children:e})]})}),i_=[{stage:"1. Start of Shift / Log In",goals:"Access Caller UI and start calling quickly",actions:"Open VanillaSoft in browser, log in",painPoints:"Slow setup; extra windows for tools",opportunities:"Single login with integrated tools; persist user layout preferences"},{stage:"2. Reviewing Next Contact",goals:"Understand contact details before call",actions:"View queue-based contact info, check external tools",painPoints:"Switching windows increases cognitive load",opportunities:"Consolidate all customer details into one panel-based interface"},{stage:"3. During the Call",goals:"Communicate, update CRM, manage compliance",actions:"Take notes, access scripts, process payments, send SMS/email",painPoints:"Switching tabs causes delays",opportunities:"Multi-panel workspace with resizable panels for scripts, compliance docs, payment tools"},{stage:"4. Post-Call Actions",goals:"Complete follow-up efficiently",actions:"Update CRM, send confirmation, schedule follow-up",painPoints:"Slow navigation, prone to errors",opportunities:"Integrate post-call actions in Caller UI; fetch follow-up tools asynchronously"},{stage:"5. Loop: Route Next Contact",goals:"Continue calling efficiently",actions:"Automatic routing based on queue",painPoints:"Manual switching causes delays",opportunities:"Automate routing and update UI dynamically"},{stage:"6. End of Shift",goals:"Log off and review performance",actions:"Review call metrics, finalize tasks",painPoints:"Data spread across systems; no quick overview",opportunities:"Centralized dashboard summarizing calls, tasks, outcomes"}];function mw(){return y.jsxs("div",{children:[y.jsx("div",{className:"bg-zinc-950 w-full text-gray-200",children:y.jsx("div",{className:"max-w-screen-lg mx-auto flex flex-nowrap space-x-1 px-6 pt-20 pb-12 mb-12 ",children:y.jsxs("div",{className:"basis-6/8",children:[y.jsx("h4",{className:"text-indigo-400 pb-4",children:"Product case 01: Scalable, Multi-Panel Workspace for High-Volume Sales Workflows"}),y.jsx("h1",{className:"text-white",children:"VanillaSoft Caller UI Redesign"}),y.jsx("h4",{className:"pt-4",children:"Redesigned the Caller UI of VanillaSoft’s sales platform to modernize its look, improve usability, and solve scalability challenges for a growing user base."})]})})}),y.jsx(va,{title:"Role & Contribution",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Led end-to-end redesign: UX research, user flows, wireframes, high-fidelity design"}),y.jsx("li",{children:"Wrote functional requirements and collaborated with developers during implementation"}),y.jsx("li",{children:"Conducted usability testing, gathered feedback, iterated designs"}),y.jsx("li",{children:"Contributed to front-end development and QA/regression testing"})]})}),y.jsxs(va,{title:"Context",children:[y.jsx("p",{className:"pb-4",children:"VanillaSoft is a cloud-based sales management platform integrating CRM, lead management, and telemarketing tools. Its queue-based approach routes agents to the next best contact, preventing cherry-picking and promoting efficiency."}),y.jsx("p",{className:"pb-2 font-semibold",children:"Problem:"}),y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Outdated UI reduced engagement and adoption"}),y.jsx("li",{children:"Agents needed multiple browser windows for external tools, increasing cognitive load"}),y.jsx("li",{children:"Scalability, responsiveness, and accessibility were limited"})]})]}),y.jsx("div",{className:"bg-white w-full text-gray-200 mb-9 border-y-1 border-zinc-400",children:y.jsx("div",{className:"w-full",children:y.jsx("div",{className:"max-w-screen-lg mx-auto flex flex-nowrap py-6 ",children:y.jsx("img",{className:"mx-6 border-zinc-600 border-1",src:hw,alt:"VanillaSoft UI overview"})})})}),y.jsx(va,{title:"Business Goal",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Modernize UI for usability and visual appeal"}),y.jsx("li",{children:"Consolidate tools into a unified interface to reduce cognitive load"}),y.jsx("li",{children:"Build a scalable, flexible UI supporting future growth"}),y.jsx("li",{children:"Ensure WCAG 2.0 accessibility compliance"}),y.jsx("li",{children:"Enable smooth integration with backend systems"})]})}),y.jsxs(va,{title:"Research & Insights",children:[y.jsx("p",{className:"pb-2 font-semibold",children:"Methods:"}),y.jsx("p",{className:"pb-4",children:"Proto-personas, market analysis, workstation photos, colleague feedback"}),y.jsx("p",{className:"pb-2 font-semibold",children:"Key Findings:"}),y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Agents used multiple windows for VanillaSoft + external tools"}),y.jsx("li",{children:"Context-switching slowed workflows and increased errors"})]}),y.jsx("p",{className:"pt-4 font-semibold",children:"Opportunity:"}),y.jsx("p",{children:"Consolidate critical tools and information into a single workspace"})]}),y.jsxs("div",{className:"w-full text-gray-800 py-6 mb-12 border-y-1 border-zinc-800 text-sm",children:[y.jsx("div",{className:"max-w-screen-xl mx-auto",children:y.jsx("h3",{className:"text-indigo-800 text-2xl pb-4",children:"User Journey: Caller UI Workflow"})}),y.jsxs("div",{className:"max-w-screen-xl mx-auto border-zinc-600 border-1",children:[y.jsxs("div",{className:"hidden md:grid grid-cols-1 md:grid-cols-6 gap-4 border-b border-gray-700 py-4 font-semibold text-zinc-800",children:[y.jsx("div",{className:"pl-4",children:"Stage"}),y.jsx("div",{children:"User Goals"}),y.jsx("div",{children:"Actions"}),y.jsx("div",{children:"Pain Points"}),y.jsx("div",{className:"col-span-2",children:"Opportunities / Solutions"})]}),y.jsx("div",{className:"hidden md:block",children:i_.map((r,e)=>y.jsxs("div",{className:`grid grid-cols-1 md:grid-cols-6 gap-4 py-2 border-b border-gray-400 ${e%2===0?"bg-zinc-100":"bg-zinc-200"}`,children:[y.jsx("div",{className:"pl-4 py-2",children:r.stage}),y.jsx("div",{className:" py-2",children:r.goals}),y.jsx("div",{className:" py-2",children:r.actions}),y.jsx("div",{className:" py-2",children:r.painPoints}),y.jsx("div",{className:"col-span-2 py-2",children:r.opportunities})]},e))}),y.jsx("div",{className:"md:hidden space-y-4",children:i_.map((r,e)=>y.jsxs("details",{className:"bg-zinc-800 rounded-lg p-4",children:[y.jsx("summary",{className:"font-semibold text-white cursor-pointer",children:r.stage}),y.jsxs("div",{className:"mt-2 space-y-2 text-gray-200",children:[y.jsxs("p",{children:[y.jsx("strong",{children:"User Goals:"})," ",r.goals]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Actions:"})," ",r.actions]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Pain Points:"})," ",r.painPoints]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Opportunities / Solutions:"})," ",r.opportunities]})]})]},e))})]})]}),y.jsxs(va,{title:"Hypothesis",children:[y.jsx("p",{className:"italic pb-4",children:"By creating a unified, flexible interface that brings together key tools—CRM, compliance, payments, and SMS/email—users will:"}),y.jsxs("ul",{className:"list-disc list-inside space-y-2 pb-4",children:[y.jsxs("li",{children:[y.jsx("strong",{children:"Work faster"})," with fewer interruptions"]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Make fewer errors"})," thanks to streamlined workflows"]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Experience less cognitive load"}),", staying focused on high-value tasks"]})]}),y.jsxs("p",{children:["This approach transforms the Caller UI from a fragmented set of windows into a"," ",y.jsx("strong",{children:"centralized, efficient workspace"})," that supports users’ natural workflow and enhances overall productivity."]})]}),y.jsx(va,{title:"Design Solution",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Flexible Multi-Panel Layout: Resizable, rearrangeable panels adapting to workflows"}),y.jsx("li",{children:"Asynchronous Data Loading: Fetch contact info in the background to reduce wait times"}),y.jsx("li",{children:"Integrated Tools: APIs for SMS, payment, and email embedded, eliminating context-switching"}),y.jsx("li",{children:"Accessibility & Responsiveness: WCAG 2.0 compliance, keyboard navigation, high-contrast design"}),y.jsx("li",{children:"Grid Layout Implementation: Kendo UI for stability, responsiveness, and performance"})]})}),y.jsx(va,{title:"Design System Contributions",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Consolidated legacy UI elements into modular, reusable components"}),y.jsx("li",{children:"Improved information architecture, microcopy, and inline editing components"}),y.jsx("li",{children:"Documented layout specifications and interaction patterns for smooth developer handoff"}),y.jsx("li",{children:"Collaborated with frontend team on .NET framework integration"})]})}),y.jsx(va,{title:"Challenges & Lessons Learned",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Balancing simplicity with feature richness"}),y.jsx("li",{children:"Migrating legacy UI without disrupting workflows"}),y.jsx("li",{children:"Coordinating cross-functional teams (design, development, QA)"}),y.jsx("li",{children:"Embedding accessibility from the start"}),y.jsx("li",{children:"Continuous user feedback ensures effective design"})]})}),y.jsx(va,{title:"Results / Impact",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsxs("li",{children:["Productivity increase: ",y.jsx("strong",{children:"30%–100%"})," reported by users"]}),y.jsx("li",{children:"Cognitive load reduction: Consolidated multiple tools into one interface"}),y.jsxs("li",{children:["User satisfaction: ",y.jsx("strong",{children:"4.7-star"})," rating on Capterra, ",y.jsx("strong",{children:"4.6"})," on G2"]}),y.jsx("li",{children:"Scalability: Design system supports future growth"}),y.jsx("li",{children:"Accessibility: WCAG 2.0 compliance achieved"})]})}),y.jsx("div",{className:" text-gray-200 border-y-1 border-zinc-800",children:y.jsx("div",{className:"w-full",children:y.jsx("div",{className:"max-w-screen-xl mx-auto   px-12 py-6  flex flex-nowrap",children:y.jsx("img",{src:pw,className:"border-zinc-600 border-1",alt:"VanillaSoft Caller UI overview"})})})})]})}const ss=({title:r,children:e})=>y.jsx("div",{className:"w-full",children:y.jsxs("div",{className:"max-w-screen-lg mx-auto px-6",children:[y.jsx("div",{children:y.jsx("h2",{className:" text-zinc-900 mb-4",children:r})}),y.jsx("div",{className:"pt-4 pb-9",children:e})]})}),a_=[{stage:"1. Enrollment Invitation Sent",tenantAdminAction:"Admin enters user’s name & email in Orchestrator",endUserAction:"—",systemResponse:"System sends enrollment email with secure one-time link",tenantAdminThoughts:"“Great, one less account I have to create manually.”",endUserThoughts:"—",painPoints:"Email may go to spam; unrecognized sender",opportunities:"Use brand visuals, friendly sender name"},{stage:"2. User Clicks Enrollment Link",tenantAdminAction:"—",endUserAction:"Clicks secure link in email",systemResponse:"Auto-login to self-service portal",tenantAdminThoughts:"—",endUserThoughts:"“Nice, no need to type credentials yet.”",painPoints:"Expired link frustrates users",opportunities:"Display expiry in email, allow resend"},{stage:"3. Create Secure Password",tenantAdminAction:"—",endUserAction:"Chooses & confirms strong password",systemResponse:"Password saved",tenantAdminThoughts:"—",endUserThoughts:"“That was easy — I feel secure.”",painPoints:"Overly strict rules may cause errors",opportunities:"Real-time password strength feedback"},{stage:"4. MFA Setup Prompt",tenantAdminAction:"—",endUserAction:"Asked to set up MFA if required",systemResponse:"MFA options: App Code, SMS, Email",tenantAdminThoughts:"—",endUserThoughts:"“Hmm, which one’s best for me?”",painPoints:"Confusion, app setup friction",opportunities:"Quick comparison of options"},{stage:"5. MFA Enrollment",tenantAdminAction:"—",endUserAction:"Completes MFA verification",systemResponse:"MFA setup confirmed",tenantAdminThoughts:"—",endUserThoughts:"“I’m ready to use VPN now.”",painPoints:"App download feels technical",opportunities:"Alternate MFA path + help"},{stage:"6. Access Confirmation",tenantAdminAction:"—",endUserAction:"—",systemResponse:"Redirect to dashboard with VPN client instructions",tenantAdminThoughts:"—",endUserThoughts:"“I know my next step.”",painPoints:"No instructions causes stalls",opportunities:"Quick start tips + visual guide"},{stage:"Loop for Additional Users",tenantAdminAction:"Admin repeats steps for each user",endUserAction:"—",systemResponse:"—",tenantAdminThoughts:"“This is tedious for large batches.”",endUserThoughts:"—",painPoints:"Bulk onboarding fatigue",opportunities:"Add CSV import feature"}];function gw(){return y.jsxs("div",{children:[y.jsx("div",{className:"bg-zinc-950 w-full text-gray-200",children:y.jsx("div",{className:"max-w-screen-lg mx-auto flex flex-nowrap space-x-1 px-6 pt-20 pb-12 mb-12 ",children:y.jsxs("div",{className:"basis-6/8",children:[y.jsx("h4",{className:"text-indigo-400 pb-4",children:"UX Case 02: Adaptiv Networks MyConnect VPN Enrollment Flow"}),y.jsx("h1",{className:"text-white",children:"Self-Service Onboarding & Multi-Factor Authentication"}),y.jsx("h4",{className:"pt-4",children:"Designed the self-service enrollment and authentication for Adaptiv Networks’ MyConnect VPN, enabling independent onboarding, secure credential setup, and MFA. Delivered a scalable, intuitive solution that balances usability with enterprise security and reduces IT support reliance for hybrid workforce management."})]})})}),y.jsxs(ss,{title:"Context",children:[y.jsx("p",{className:"pb-4",children:"Adaptiv Networks is a multi-tenant provider of cloud-managed networking solutions, specializing in Software-Defined Wide Area Network (SD-WAN) technology. Their platform enables businesses to optimize network performance, reliability, and security while simplifying management and reducing operational costs."}),y.jsx("p",{className:"pb-4",children:"To support hybrid and remote workforces, Adaptiv Networks offers MyConnect VPN, a secure remote access solution that integrates with their SD-WAN infrastructure. Efficient onboarding and authentication for remote employees, partners, and tenants is critical to ensure seamless connectivity, protect sensitive data, and maintain enterprise-grade security."})]}),y.jsx(ss,{title:"Business Problem",children:y.jsxs("ul",{className:"list-disc list-outside space-y-1 pl-4",children:[y.jsxs("li",{children:[y.jsx("strong",{children:"Manual onboarding is resource-intensive and does not scale:"}),y.jsx("p",{children:"IT teams must create accounts individually, slowing adoption for partners, tenants, and new employees."})]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Limited self-service capabilities restrict user independence:"}),y.jsx("p",{children:"Customers cannot independently onboard or manage users, increasing operational overhead."})]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Security and compliance are paramount:"}),y.jsx("p",{children:"Multi-Factor Authentication (MFA) is required to meet industry standards, but default workflows can be confusing or inconsistent for end users."})]}),y.jsxs("li",{children:[y.jsx("strong",{children:"High reliance on IT support reduces efficiency:"}),y.jsx("p",{children:"Without an intuitive self-service experience, organizations face higher support costs and slower user adoption."})]})]})}),y.jsx(ss,{title:"Business Goal",children:y.jsxs("ul",{className:"list-disc list-outside space-y-1 pl-4",children:[y.jsxs("li",{children:[y.jsx("strong",{children:"Streamline Onboarding & Self-Management:"}),"Deliver an automated, user-friendly enrollment flow that reduces IT dependency and accelerates adoption."]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Enhance Security & Compliance:"}),"Implement flexible MFA options to protect sensitive data and meet enterprise security requirements."]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Enable Scalable Operations:"}),"Provide a multi-tenant, self-service solution that supports partners and tenants independently, with potential premium features for recurring revenue."]})]})}),y.jsx(ss,{title:"Research",children:y.jsx("p",{className:"pb-4",children:"Mapped user flows: enrollment, login, password reset, and MFA. Identified pain points to ensure a smooth user journey. Auth0 was selected as the IAM vendor; documentation was reviewed to understand framework capabilities and optimize experience."})}),y.jsx("div",{className:"w-full text-gray-800 py-6 mb-12 border-y-1 border-zinc-800 text-sm",children:y.jsxs("div",{className:"max-w-screen-xl mx-auto",children:[y.jsx("h3",{className:"text-indigo-800 text-2xl pb-8",children:"User Journey: Caller UI Workflow"}),y.jsxs("div",{className:"hidden md:grid grid-cols-1 md:grid-cols-6 gap-4 border-b border-gray-700 pb-4 font-semibold text-zinc-800",children:[y.jsx("div",{children:"Stage"}),y.jsx("div",{children:"Tenant/Admin Action"}),y.jsx("div",{children:"End-User Action"}),y.jsx("div",{children:"System Response"}),y.jsx("div",{children:"Tenant/Admin Thoughts"}),y.jsx("div",{children:"End-User Thoughts"}),y.jsx("div",{children:"Pain Points / Risks"}),y.jsx("div",{children:"Opportunities / Improvement"})]}),y.jsx("div",{className:"hidden md:block",children:a_.map((r,e)=>y.jsxs("div",{className:`grid grid-cols-1 md:grid-cols-6 gap-4 py-2 border-b border-gray-400 ${e%2===0?"bg-zinc-200":"bg-zinc-300"}`,children:[y.jsx("div",{className:"px-2 py-1",children:r.stage}),y.jsx("div",{className:"px-2 py-1",children:r.tenantAdminAction}),y.jsx("div",{className:"px-2 py-1",children:r.endUserAction}),y.jsx("div",{className:"px-2 py-1",children:r.systemResponse}),y.jsx("div",{className:"px-2 py-1",children:r.tenantAdminThoughts}),y.jsx("div",{className:"px-2 py-1",children:r.endUserThoughts}),y.jsx("div",{className:"px-2 py-1",children:r.painPoints}),y.jsx("div",{className:"px-2 py-1",children:r.opportunities})]},e))}),y.jsx("div",{className:"md:hidden space-y-4",children:a_.map((r,e)=>y.jsxs("details",{className:"bg-zinc-800 rounded-lg p-4",children:[y.jsx("summary",{className:"font-semibold text-white cursor-pointer",children:r.stage}),y.jsxs("div",{className:"mt-2 space-y-2 text-gray-200",children:[y.jsxs("p",{children:[y.jsx("strong",{children:"Tenant/Admin Action:"})," ",r.tenantAdminAction]}),y.jsxs("p",{children:[y.jsx("strong",{children:"End-User Action:"})," ",r.endUserAction]}),y.jsxs("p",{children:[y.jsx("strong",{children:"System Response:"})," ",r.systemResponse]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Tenant/Admin Thoughts:"})," ",r.tenantAdminThoughts]}),y.jsxs("p",{children:[y.jsx("strong",{children:"End-User Thoughts:"})," ",r.endUserThoughts]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Pain Points / Risks:"})," ",r.painPoints]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Opportunities / Improvement:"})," ",r.opportunities]})]})]},e))})]})}),y.jsxs(ss,{title:"Hypothesis",children:[y.jsx("p",{className:"italic pb-4",children:"By designing a self-service VPN enrollment flow with integrated MFA guidance, users will:"}),y.jsxs("ul",{className:"list-disc list-outside space-y-2 ml-4 pb-4",children:[y.jsxs("li",{children:[y.jsx("strong",{children:"Onboard faster"})," without relying on IT support"]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Complete security steps confidently"})," with clear MFA instructions and options"]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Manage multiple accounts efficiently"})," in a multi-tenant environment"]})]}),y.jsxs("p",{children:["This approach transforms VPN onboarding from a technical, error-prone process into a ",y.jsx("strong",{children:"streamlined, user-friendly experience"})," that balances security, usability, and scalability."]})]}),y.jsx(ss,{title:"Solution",children:y.jsx("p",{className:"pb-4",children:"Partners/Tenants submit first name, last name, and email. Users receive a one-time password via email. Clicking the link auto-logs the user into the self-service portal. Users set a secure password, then complete MFA if purchased, adding a layer of security."})}),y.jsx(ss,{title:"User Outcomes",children:y.jsxs("ul",{className:"list-disc list-outside space-y-1 pl-4",children:[y.jsxs("li",{children:[y.jsx("strong",{children:"One-Time Code (App-based):"})," Most frustrating; app download, QR code scan, backup code required."]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Text (SMS):"})," Minimal complaints; quick and familiar for users."]}),y.jsxs("li",{children:[y.jsx("strong",{children:"Email:"})," Convenient; longer code lifespan; easy to copy/paste, though slightly less secure than SMS."]})]})}),y.jsx(ss,{title:"Observations",children:y.jsx("p",{className:"pb-4",children:"MFA implementation highlighted weaknesses in default Auth0 options and a lack of tailored security guidance. Users/developers may assume full protection without understanding trade-offs. Clear guidance and penetration testing are recommended to select MFA strategies that align with organizational security needs."})})]})}const _a=({title:r,children:e})=>y.jsx("div",{className:"w-full",children:y.jsxs("div",{className:"max-w-screen-lg mx-auto px-6",children:[y.jsx("div",{children:y.jsx("h2",{className:" text-zinc-900 mb-4",children:r})}),y.jsx("div",{className:"pt-4 pb-9",children:e})]})}),s_=[{stage:"Login / Start Shift",tenantAdminAction:"Set up rules and priority levels (P1, P2, subgroups).",endUserAction:"Logs into VanillaSoft dashboard; sees queued leads based on priority and last result codes.",systemResponse:"Displays leads in queue order automatically based on rules and last result codes.",tenantAdminThoughts:"I hope the queue reflects our rules correctly.",endUserThoughts:"System already knows my top leads.",painPoints:"Initial skepticism about automated priorities.",opportunities:"Show a summary or visual cue explaining lead prioritization."},{stage:"Review Automated Queue",tenantAdminAction:"Monitor queue performance and adjust if needed.",endUserAction:"Reviews queued leads to decide which to contact first.",systemResponse:"Highlights high-priority leads visually (color coding, icons).",tenantAdminThoughts:"Are top leads really correct based on our rules?",endUserThoughts:"I can start with the highest-priority leads.",painPoints:"Complexity of priority rules may be unclear.",opportunities:"Visual indicators to explain priority and scheduling logic."},{stage:"Examine Lead Details",tenantAdminAction:"Ensure all necessary data points are available for agents.",endUserAction:"Opens lead profiles for context before outreach.",systemResponse:"Displays last result code, engagement score, and subgroup info.",tenantAdminThoughts:"Do agents have enough context?",endUserThoughts:"I have context on each lead’s last activity and priority.",painPoints:"Incomplete data can confuse agent decisions.",opportunities:"Inline summary of key metrics affecting prioritization."},{stage:"Outreach / Contact",tenantAdminAction:"Monitor engagement and follow-up metrics.",endUserAction:"Contacts lead via preferred channel (call, email, SMS).",systemResponse:"Automatically updates lead status and reschedules based on outcome.",tenantAdminThoughts:"Are agents contacting leads efficiently?",endUserThoughts:"I’m engaging the right leads at the right time.",painPoints:"Risk of missing leads if rules misunderstood.",opportunities:"Tooltip indicating why this lead was queued now."},{stage:"Record Outcome / Update Result Code",tenantAdminAction:"Adjust rules if patterns emerge.",endUserAction:"Logs call result or engagement outcome.",systemResponse:"Re-queues leads dynamically based on new result codes.",tenantAdminThoughts:"Rules need to adapt automatically.",endUserThoughts:"System adapts automatically; no manual sorting required.",painPoints:"High volume can be overwhelming without cues.",opportunities:"Dynamic preview of next lead to reduce uncertainty."},{stage:"Continuous Monitoring",tenantAdminAction:"Review metrics: call volume, conversions, engagement.",endUserAction:"Observes progress toward daily goals.",systemResponse:"Provides dashboard visualizations and insights.",tenantAdminThoughts:"Are rules achieving desired results?",endUserThoughts:"I can see how effective the queue is.",painPoints:"Interpreting raw data can be challenging.",opportunities:"Dashboards with clear KPIs and visual insights."},{stage:"Iteration / Optimization",tenantAdminAction:"Refine rules or subgroups (P1a, P1b) for better outcomes.",endUserAction:"—",systemResponse:"System applies new rules dynamically.",tenantAdminThoughts:"Optimization improves efficiency over time.",endUserThoughts:"—",painPoints:"Frequent changes can confuse agents.",opportunities:"Communicate updates clearly with notifications."}];function vw(){return y.jsxs(y.Fragment,{children:[y.jsx("div",{className:"bg-zinc-950 w-full text-gray-200",children:y.jsx("div",{className:"max-w-screen-lg mx-auto flex flex-nowrap space-x-1 px-6 pt-20 pb-12 mb-12 ",children:y.jsxs("div",{className:"basis-6/8",children:[y.jsx("h4",{className:"text-indigo-400",children:"Dynamic, Multi-Level Contact Prioritization for Sales Efficiency"}),y.jsx("h1",{className:"",children:"UX Case 03: Intellective Routing"}),y.jsx("h4",{className:"basis-1/3 pt-6",children:"Designed a multi-level contact prioritization framework for VanillaSoft that lets sales teams create custom rules to focus on high-value leads. The solution improved workflow efficiency, boosted conversion rates, and enhanced user satisfaction by balancing powerful features with a simple, intuitive design."})]})})}),y.jsx(_a,{title:"Role & Contribution",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Led end-to-end feature design: research, user flows, wireframes, high-fidelity UI design."}),y.jsx("li",{children:"Defined functional requirements and collaborated with developers during implementation."}),y.jsx("li",{children:"Conducted usability testing and iterated designs based on agent feedback."}),y.jsx("li",{children:"Designed a visual query-building interface to simplify complex prioritization logic."}),y.jsx("li",{children:"Customers also needed flexibility to use any data type and create subgroups (e.g., P1a, P1b), increasing complexity."})]})}),y.jsx(_a,{title:"Context",children:y.jsx("p",{className:"pb-4",children:"VanillaSoft is a cloud-based sales management platform integrating CRM, lead management, and telemarketing tools. It uses a queue-based approach to guide agents to the next best contact, based on data points such as renewal dates, rather than static lists. This ensures sales teams focus on the most relevant leads at the optimal time."})}),y.jsx(_a,{title:"Business Problem",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Customers requested the ability to implement multiple levels of prioritization (P1, P2, etc.) to better target high-value leads."}),y.jsx("li",{children:"Current platform lacked dynamic prioritization, limiting workflow efficiency."}),y.jsx("li",{children:"Customers also needed flexibility to use any data type and create subgroups (e.g., P1a, P1b), increasing complexity."})]})}),y.jsx(_a,{title:"Business Goal",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Improve sales team efficiency and conversion rates by directing agents to the most promising leads."}),y.jsx("li",{children:"Provide flexibility to define rules across diverse data types and multiple levels of prioritization."}),y.jsx("li",{children:"Ensure the system remains intuitive and accessible to prevent cognitive overload."})]})}),y.jsxs(_a,{title:"Research and Insights",children:[y.jsxs("p",{className:"pb-4",children:[y.jsx("strong",{children:"Methods:"})," Customer feedback analysis, scenario mapping, edge case exploration."]}),y.jsx("p",{className:"pb-4",children:y.jsx("strong",{children:"Findings:"})}),y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Customers required complex inclusion/exclusion rules (e.g., prioritize A, C, F unless B = X)."}),y.jsx("li",{children:"Early limitations risked extensive rework later. Supporting broad flexibility from the start was safer."}),y.jsx("li",{children:"Designing for both power users and non-technical users was essential."})]})]}),y.jsxs("div",{className:"w-full text-gray-200 text-sm",children:[y.jsx("div",{className:"max-w-screen-xl mx-auto",children:y.jsx("h3",{className:"text-indigo-400 text-2xl pb-8",children:"User Journey"})}),y.jsx("div",{className:"w-full bg-zinc-900 text-gray-200 pt-6 mb-18",children:y.jsxs("div",{className:"max-w-screen-xl mx-auto px-4",children:[y.jsxs("div",{className:"hidden md:grid grid-cols-8 gap-4 border-b border-gray-700 pb-4 font-semibold text-white",children:[y.jsx("div",{children:"Stage"}),y.jsx("div",{children:"Tenant/Admin Action"}),y.jsx("div",{children:"End-User Action"}),y.jsx("div",{children:"System Response"}),y.jsx("div",{children:"Tenant/Admin Thoughts"}),y.jsx("div",{children:"End-User Thoughts"}),y.jsx("div",{children:"Pain Points / Risks"}),y.jsx("div",{children:"Opportunities / Improvement"})]}),y.jsx("div",{className:"hidden md:block",children:s_.map((r,e)=>y.jsxs("div",{className:`grid grid-cols-8 gap-4 py-4 border-b border-gray-800 ${e%2===0?"bg-zinc-900":"bg-zinc-800"}`,children:[y.jsx("div",{className:"px-2 py-1",children:r.stage}),y.jsx("div",{className:"px-2 py-1",children:r.tenantAdminAction}),y.jsx("div",{className:"px-2 py-1",children:r.endUserAction}),y.jsx("div",{className:"px-2 py-1",children:r.systemResponse}),y.jsx("div",{className:"px-2 py-1",children:r.tenantAdminThoughts}),y.jsx("div",{className:"px-2 py-1",children:r.endUserThoughts}),y.jsx("div",{className:"px-2 py-1",children:r.painPoints}),y.jsx("div",{className:"px-2 py-1",children:r.opportunities})]},e))}),y.jsx("div",{className:"md:hidden space-y-4",children:s_.map((r,e)=>y.jsxs("details",{className:"bg-zinc-800 rounded-lg p-4",children:[y.jsx("summary",{className:"font-semibold text-white cursor-pointer",children:r.stage}),y.jsxs("div",{className:"mt-2 space-y-2 text-gray-200",children:[y.jsxs("p",{children:[y.jsx("strong",{children:"Tenant/Admin Action:"})," ",r.tenantAdminAction]}),y.jsxs("p",{children:[y.jsx("strong",{children:"End-User Action:"})," ",r.endUserAction]}),y.jsxs("p",{children:[y.jsx("strong",{children:"System Response:"})," ",r.systemResponse]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Tenant/Admin Thoughts:"})," ",r.tenantAdminThoughts]}),y.jsxs("p",{children:[y.jsx("strong",{children:"End-User Thoughts:"})," ",r.endUserThoughts]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Pain Points / Risks:"})," ",r.painPoints]}),y.jsxs("p",{children:[y.jsx("strong",{children:"Opportunities / Improvement:"})," ",r.opportunities]})]})]},e))})]})})]}),y.jsxs(_a,{title:"Hypothesis",children:[y.jsx("p",{className:"pb-4",children:"By implementing a customizable prioritization framework, users will:"}),y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Focus on the most relevant leads at the right time."}),y.jsx("li",{children:"Improve efficiency and shorten sales cycles."}),y.jsx("li",{children:"Adapt workflows without vendor or IT support."})]}),y.jsx("p",{className:"pt-4",children:"However, without a clear and intuitive UI, the complexity could overwhelm users. Simplicity in interaction design would be critical to adoption."})]}),y.jsxs(_a,{title:"Design Solution",children:[y.jsx("p",{className:"pb-4",children:"Query-Building Framework for Prioritization"}),y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Enhanced Lead Prioritization: Implemented real-time, customizable routing filters that dynamically rank leads based on various criteria, ensuring agents always engage with the most relevant prospects."}),y.jsx("li",{children:"Streamlined Workflow: Introduced a queue-based routing system that automates lead assignment, reducing decision fatigue and allowing agents to focus on high-value interactions."}),y.jsx("li",{children:"Continuous Optimization: Developed an intuitive interface for administrators to adjust routing filters and criteria in real-time, enabling ongoing refinement of lead prioritization strategies without disrupting agent productivity."})]})]}),y.jsx(_a,{title:"Challenges & Lessons Learned",children:y.jsxs("ul",{className:"list-disc list-inside space-y-1",children:[y.jsx("li",{children:"Balancing flexibility with simplicity in the user interface."}),y.jsx("li",{children:"Designing a rules builder that communicates complex conditions clearly."}),y.jsx("li",{children:"Ensuring adaptability to future scenarios without costly rework."})]})}),y.jsx(_a,{title:"Results / Impact",children:y.jsxs("ul",{children:[y.jsx("li",{children:"Achieved a 500% increase in call volume without additional operational overhead, as reported by One of a Kind Sales."}),y.jsx("li",{children:"Streamlined lead management processes, reducing manual intervention and administrative overhead, as experienced by SalesRoads."}),y.jsx("li",{children:"Enhanced lead prioritization and routing, leading to improved sales efficiency and conversion rates."})]})})]})}function _w(){return y.jsx("h1",{className:"text-3xl font-bold",children:"Resume"})}function xw(){return y.jsx("h1",{className:"text-3xl font-bold",children:"Certification"})}function yw(){const[r,e]=me.useState(window.innerWidth>=768),[i,s]=me.useState(window.innerWidth<768),l=Ra(),c=()=>{e(f=>!f)};return me.useEffect(()=>{const f=()=>{const p=window.innerWidth<768;s(p),e(!p)};return window.addEventListener("resize",f),f(),()=>window.removeEventListener("resize",f)},[]),me.useEffect(()=>{i&&e(!1)},[l,i]),y.jsxs(y.Fragment,{children:[y.jsx(ow,{className:"bg-zinc-950"}),y.jsxs("div",{className:"flex flex-col h-screen w-screen",children:[y.jsx(lw,{toggleMenu:c}),y.jsxs("div",{className:"flex flex-1 overflow-hidden relative",children:[y.jsx("aside",{className:`w-56 h-full overflow-y-auto flex flex-col transition-all duration-300 
              ${r?"ml-0":"-ml-56"} top-0 left-0 z-40 relative`,children:y.jsx(uw,{})}),r&&i&&y.jsx("div",{onClick:()=>e(!1),className:"fixed inset-0 z-30",style:{backgroundColor:"rgba(0, 0, 0, 0.3)"}}),y.jsx("main",{className:"flex-1 overflow-y-auto overscroll-contain ml-0",children:y.jsxs(mM,{children:[y.jsx(rs,{path:"/",element:y.jsx(fw,{})}),y.jsx(rs,{path:"/about",element:y.jsx(dw,{})}),y.jsx(rs,{path:"/case01",element:y.jsx(mw,{})}),y.jsx(rs,{path:"/case02",element:y.jsx(gw,{})}),y.jsx(rs,{path:"/case03",element:y.jsx(vw,{})}),y.jsx(rs,{path:"/resume",element:y.jsx(_w,{})}),y.jsx(rs,{path:"/certification",element:y.jsx(xw,{})})]})})]}),y.jsx(cw,{})]})]})}vS.createRoot(document.getElementById("root")).render(y.jsx(me.StrictMode,{children:y.jsx(zM,{basename:"/portfolio",children:y.jsx(yw,{})})}));
