 ...
 */var H0;function ay(){if(H0)return Bo;H0=1;var r=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(s,l,c){var f=null;if(c!==void 0&&(f=""+c),l.key!==void 0&&(f=""+l.key),"key"in l){c={};for(var p in l)p!=="key"&&(c[p]=l[p])}else c=l;return l=c.ref,{$$typeof:r,type:s,key:f,ref:l!==void 0?l:null,props:c}}return Bo.Fragment=e,Bo.jsx=i,Bo.jsxs=i,Bo}var G0;function sy(){return G0||(G0=1,md.exports=ay()),md.exports}var g=sy(),gd={exports:{}},ut={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var j0;function oy(){return j0||(j0=1,function(r){function e(I,H){var de=I.length;I.push(H);e:for(;0<de;){var ve=de-1>>>1,P=I[ve];if(0<l(P,H))I[ve]=H,I[de]=P,de=ve;else break e}}function i(I){return I.length===0?null:I[0]}function s(I){if(I.length===0)return null;var H=I[0],de=I.pop();if(de!==H){I[0]=de;e:for(var ve=0,P=I.length,K=P>>>1;ve<K;){var pe=2*(ve+1)-1,Se=I[pe],Ue=pe+1,Ye=I[Ue];if(0>l(Se,de))Ue<P&&0>l(Ye,Se)?(I[ve]=Ye,I[Ue]=de,ve=Ue):(I[ve]=Se,I[pe]=de,ve=pe);else if(Ue<P&&0>l(Ye,de))I[ve]=Ye,I[Ue]=de,ve=Ue;else break e}}return H}function l(I,H){var de=I.sortIndex-H.sortIndex;return de!==0?de:I.id-H.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,p=f.now();r.unstable_now=function(){return f.now()-p}}var m=[],h=[],v=1,S=null,_=3,b=!1,T=!1,C=!1,M=!1,y=typeof setTimeout=="function"?setTimeout:null,D=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;function L(I){for(var H=i(h);H!==null;){if(H.callback===null)s(h);else if(H.startTime<=I)s(h),H.sortIndex=H.expirationTime,e(m,H);else break;H=i(h)}}function B(I){if(C=!1,L(I),!T)if(i(m)!==null)T=!0,G||(G=!0,te());else{var H=i(h);H!==null&&Q(B,H.startTime-I)}}var G=!1,k=-1,A=5,O=-1;function he(){return M?!0:!(r.unstable_now()-O<A)}function V(){if(M=!1,G){var I=r.unstable_now();O=I;var H=!0;try{e:{T=!1,C&&(C=!1,D(k),k=-1),b=!0;var de=_;try{t:{for(L(I),S=i(m);S!==null&&!(S.expirationTime>I&&he());){var ve=S.callback;if(typeof ve=="function"){S.callback=null,_=S.priorityLevel;var P=ve(S.expirationTime<=I);if(I=r.unstable_now(),typeof P=="function"){S.callback=P,L(I),H=!0;break t}S===i(m)&&s(m),L(I)}else s(m);S=i(m)}if(S!==null)H=!0;else{var K=i(h);K!==null&&Q(B,K.startTime-I),H=!1}}break e}finally{S=null,_=de,b=!1}H=void 0}}finally{H?te():G=!1}}}var te;if(typeof N=="function")te=function(){N(V)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,ue=se.port2;se.port1.onmessage=V,te=function(){ue.postMessage(null)}}else te=function(){y(V,0)};function Q(I,H){k=y(function(){I(r.unstable_now())},H)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(I){I.callback=null},r.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<I?Math.floor(1e3/I):5},r.unstable_getCurrentPriorityLevel=function(){return _},r.unstable_next=function(I){switch(_){case 1:case 2:case 3:var H=3;break;default:H=_}var de=_;_=H;try{return I()}finally{_=de}},r.unstable_requestPaint=function(){M=!0},r.unstable_runWithPriority=function(I,H){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var de=_;_=I;try{return H()}finally{_=de}},r.unstable_scheduleCallback=function(I,H,de){var ve=r.unstable_now();switch(typeof de=="object"&&de!==null?(de=de.delay,de=typeof de=="number"&&0<de?ve+de:ve):de=ve,I){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=de+P,I={id:v++,callback:H,priorityLevel:I,startTime:de,expirationTime:P,sortIndex:-1},de>ve?(I.sortIndex=de,e(h,I),i(m)===null&&I===i(h)&&(C?(D(k),k=-1):C=!0,Q(B,de-ve))):(I.sortIndex=P,e(m,I),T||b||(T=!0,G||(G=!0,te()))),I},r.unstable_shouldYield=he,r.unstable_wrapCallback=function(I){var H=_;return function(){var de=_;_=H;try{return I.apply(this,arguments)}finally{_=de}}}}(_d)),_d}var X0;function ly(){return X0||(X0=1,xd.exports=oy()),xd.exports}var Sd={exports:{}},Cn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var W0;function cy(){if(W0)return Cn;W0=1;var r=$h();function e(m){var h="https://react.dev/errors/"+m;if(1<arguments.length){h+="?args[]="+encodeURIComponent(arguments[1]);for(var v=2;v<arguments.length;v++)h+="&args[]="+encodeURIComponent(arguments[v])}return"Minified React error #"+m+"; visit "+h+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var s={d:{f:i,r:function(){throw Error(e(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},l=Symbol.for("react.portal");function c(m,h,v){var S=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:l,key:S==null?null:""+S,children:m,containerInfo:h,implementation:v}}var f=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function p(m,h){if(m==="font")return"";if(typeof h=="string")return h==="use-credentials"?h:""}return Cn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Cn.createPortal=function(m,h){var v=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!h||h.nodeType!==1&&h.nodeType!==9&&h.nodeType!==11)throw Error(e(299));return c(m,h,null,v)},Cn.flushSync=function(m){var h=f.T,v=s.p;try{if(f.T=null,s.p=2,m)return m()}finally{f.T=h,s.p=v,s.d.f()}},Cn.preconnect=function(m,h){typeof m=="string"&&(h?(h=h.crossOrigin,h=typeof h=="string"?h==="use-credentials"?h:"":void 0):h=null,s.d.C(m,h))},Cn.prefetchDNS=function(m){typeof m=="string"&&s.d.D(m)},Cn.preinit=function(m,h){if(typeof m=="string"&&h&&typeof h.as=="string"){var v=h.as,S=p(v,h.crossOrigin),_=typeof h.integrity=="string"?h.integrity:void 0,b=typeof h.fetchPriority=="string"?h.fetchPriority:void 0;v==="style"?s.d.S(m,typeof h.precedence=="string"?h.precedence:void 0,{crossOrigin:S,integrity:_,fetchPriority:b}):v==="script"&&s.d.X(m,{crossOrigin:S,integrity:_,fetchPriority:b,nonce:typeof h.nonce=="string"?h.nonce:void 0})}},Cn.preinitModule=function(m,h){if(typeof m=="string")if(typeof h=="object"&&h!==null){if(h.as==null||h.as==="script"){var v=p(h.as,h.crossOrigin);s.d.M(m,{crossOrigin:v,integrity:typeof h.integrity=="string"?h.integrity:void 0,nonce:typeof h.nonce=="string"?h.nonce:void 0})}}else h==null&&s.d.M(m)},Cn.preload=function(m,h){if(typeof m=="string"&&typeof h=="object"&&h!==null&&typeof h.as=="string"){var v=h.as,S=p(v,h.crossOrigin);s.d.L(m,v,{crossOrigin:S,integrity:typeof h.integrity=="string"?h.integrity:void 0,nonce:typeof h.nonce=="string"?h.nonce:void 0,type:typeof h.type=="string"?h.type:void 0,fetchPriority:typeof h.fetchPriority=="string"?h.fetchPriority:void 0,referrerPolicy:typeof h.referrerPolicy=="string"?h.referrerPolicy:void 0,imageSrcSet:typeof h.imageSrcSet=="string"?h.imageSrcSet:void 0,imageSizes:typeof h.imageSizes=="string"?h.imageSizes:void 0,media:typeof h.media=="string"?h.media:void 0})}},Cn.preloadModule=function(m,h){if(typeof m=="string")if(h){var v=p(h.as,h.crossOrigin);s.d.m(m,{as:typeof h.as=="string"&&h.as!=="script"?h.as:void 0,crossOrigin:v,integrity:typeof h.integrity=="string"?h.integrity:void 0})}else s.d.m(m)},Cn.requestFormReset=function(m){s.d.r(m)},Cn.unstable_batchedUpdates=function(m,h){return m(h)},Cn.useFormState=function(m,h,v){return f.H.useFormState(m,h,v)},Cn.useFormStatus=function(){return f.H.useHostTransitionStatus()},Cn.version="19.1.0",Cn}var q0;function uy(){if(q0)return Sd.exports;q0=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(e){console.error(e)}}return r(),Sd.exports=cy(),Sd.exports}/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ma,depthTest:!1,depthWrite:!1})}function nA(r,e,i){const s=new Float32Array(Ls),l=new oe(0,1,0);return new qi({name:"SphericalGaussianBlur",defines:{n:Ls,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:fu(),fragmentShader:`
		...
		`,blending:Ma,depthTest:!1,depthWrite:!1})}function Iv(){return new qi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fu(),fragmentShader:`
		...
		`,blending:Ma,depthTest:!1,depthWrite:!1})}function Fv(){return new qi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fu(),fragmentShader:`
	...
	`}class Jx extends Ai{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new qx(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new ol(5,5,5),c=new qi({name:"CubemapFromEquirect",uniforms:Br(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:kn,blending:Ma});c.uniforms.tEquirect.value=i;const f=new di(l,c),p=i.minFilter;return i.minFilter===Os&&(i.minFilter=dn),new lE(1,10,this).update(e,f),i.minFilter=p,f.geometry.dispose(),f.material.dispose(),this}clear(e,i=!0,s=!0,l=!0){const c=e.getRenderTarget();for(let f=0;f<6;f++)e.setRenderTarget(this,f),e.clear(i,s,l);e.setRenderTarget(c)}}function iA(r){let e=new WeakMap,i=new WeakMap,s=null;function l(_,b=!1){return _==null?null:b?f(_):c(_)}function c(_){if(_&&_.isTexture){const b=_.mapping;if(b===Ed||b===Td)if(e.has(_)){const T=e.get(_).texture;return p(T,_.mapping)}else{const T=_.image;if(T&&T.height>0){const C=new Jx(T.height);return C.fromEquirectangularTexture(r,_),e.set(_,C),_.addEventListener("dispose",h),p(C.texture,_.mapping)}else return null}}return _}function f(_){if(_&&_.isTexture){const b=_.mapping,T=b===Ed||b===Td,C=b===Fs||b===Pr;if(T||C){let M=i.get(_);const y=M!==void 0?M.texture.pmremVersion:0;if(_.isRenderTargetTexture&&_.pmremVersion!==y)return s===null&&(s=new Ov(r)),M=T?s.fromEquirectangular(_,M):s.fromCubemap(_,M),M.texture.pmremVersion=_.pmremVersion,i.set(_,M),M.texture;if(M!==void 0)return M.texture;{const D=_.image;return T&&D&&D.height>0||C&&D&&m(D)?(s===null&&(s=new Ov(r)),M=T?s.fromEquirectangular(_):s.fromCubemap(_),M.texture.pmremVersion=_.pmremVersion,i.set(_,M),_.addEventListener("dispose",v),M.texture):null}}}return _}function p(_,b){return b===Ed?_.mapping=Fs:b===Td&&(_.mapping=Pr),_}function m(_){let b=0;const T=6;for(let C=0;C<T;C++)_[C]!==void 0&&b++;return b===T}function h(_){const b=_.target;b.removeEventListener("dispose",h);const T=e.get(b);T!==void 0&&(e.delete(b),T.dispose())}function v(_){const b=_.target;b.removeEventListener("dispose",v);const T=i.get(b);T!==void 0&&(i.delete(b),T.dispose())}function S(){e=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:S}}function aA(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&iu("WebGLRenderer: "+s+" extension not supported."),l}}}function sA(r,e,i,s){const l={},c=new WeakMap;function f(S){const _=S.target;_.index!==null&&e.remove(_.index);for(const T in _.attributes)e.remove(_.attributes[T]);_.removeEventListener("dispose",f),delete l[_.id];const b=c.get(_);b&&(e.remove(b),c.delete(_)),s.releaseStatesOfGeometry(_),_.isInstancedBufferGeometry===!0&&delete _._maxInstanceCount,i.memory.geometries--}function p(S,_){return l[_.id]===!0||(_.addEventListener("dispose",f),l[_.id]=!0,i.memory.geometries++),_}function m(S){const _=S.attributes;for(const b in _)e.update(_[b],r.ARRAY_BUFFER)}function h(S){const _=[],b=S.index,T=S.attributes.position;let C=0;if(T===void 0)return;if(b!==null){const D=b.array;C=b.version;for(let N=0,L=D.length;N<L;N+=3){const B=D[N+0],G=D[N+1],k=D[N+2];_.push(B,G,G,k,k,B)}}else{const D=T.array;C=T.version;for(let N=0,L=D.length/3-1;N<L;N+=3){const B=N+0,G=N+1,k=N+2;_.push(B,G,G,k,k,B)}}const M=new(T.count>=65535?Vx:Gx)(_,1);M.version=C;const y=c.get(S);y&&e.remove(y),c.set(S,M)}function v(S){const _=c.get(S);if(_){const b=S.index;b!==null&&_.version<b.version&&h(S)}else h(S);return c.get(S)}return{get:p,update:m,getWireframeAttribute:v}}function rA(r,e,i){let s;function l(_){s=_}let c,f;function p(_){c=_.type,f=_.bytesPerElement}function m(_,b){r.drawElements(s,b,c,_*f),i.update(b,s,1)}function h(_,b,T){T!==0&&(r.drawElementsInstanced(s,b,c,_*f,T),i.update(b,s,T))}function v(_,b,T){if(T===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,b,0,c,_,0,T);let M=0;for(let y=0;y<T;y++)M+=b[y];i.update(M,s,1)}function S(_,b,T,C){if(T===0)return;const M=e.get("WEBGL_multi_draw");if(M===null)for(let y=0;y<_.length;y++)h(_[y]/f,b[y],C[y]);else{M.multiDrawElementsInstancedWEBGL(s,b,0,c,_,0,C,0,T);let y=0;for(let D=0;D<T;D++)y+=b[D]*C[D];i.update(y,s,1)}}this.setMode=l,this.setIndex=p,this.render=m,this.renderInstances=h,this.renderMultiDraw=v,this.renderMultiDrawInstances=S}function oA(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,p){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=p*(c/3);break;case r.LINES:i.lines+=p*(c/2);break;case r.LINE_STRIP:i.lines+=p*(c-1);break;case r.LINE_LOOP:i.lines+=p*c;break;case r.POINTS:i.points+=p*c;break;default:Rt("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function lA(r,e,i){const s=new WeakMap,l=new tn;function c(f,p,m){const h=f.morphTargetInfluences,v=p.morphAttributes.position||p.morphAttributes.normal||p.morphAttributes.color,S=v!==void 0?v.length:0;let _=s.get(p);if(_===void 0||_.count!==S){let he=function(){A.dispose(),s.delete(p),p.removeEventListener("dispose",he)};var b=he;_!==void 0&&_.texture.dispose();const T=p.morphAttributes.position!==void 0,C=p.morphAttributes.normal!==void 0,M=p.morphAttributes.color!==void 0,y=p.morphAttributes.position||[],D=p.morphAttributes.normal||[],N=p.morphAttributes.color||[];let L=0;T===!0&&(L=1),C===!0&&(L=2),M===!0&&(L=3);let B=p.attributes.position.count*L,G=1;B>e.maxTextureSize&&(G=Math.ceil(B/e.maxTextureSize),B=e.maxTextureSize);const k=new Float32Array(B*G*4*S),A=new Bx(k,B,G,S);A.type=Ti,A.needsUpdate=!0;const O=L*4;for(let V=0;V<S;V++){const te=y[V],se=D[V],ue=N[V],Q=B*G*4*V;for(let I=0;I<te.count;I++){const H=I*O;T===!0&&(l.fromBufferAttribute(te,I),k[Q+H+0]=l.x,k[Q+H+1]=l.y,k[Q+H+2]=l.z,k[Q+H+3]=0),C===!0&&(l.fromBufferAttribute(se,I),k[Q+H+4]=l.x,k[Q+H+5]=l.y,k[Q+H+6]=l.z,k[Q+H+7]=0),M===!0&&(l.fromBufferAttribute(ue,I),k[Q+H+8]=l.x,k[Q+H+9]=l.y,k[Q+H+10]=l.z,k[Q+H+11]=ue.itemSize===4?l.w:1)}}_={count:S,texture:A,size:new ot(B,G)},s.set(p,_),p.addEventListener("dispose",he)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let T=0;for(let M=0;M<h.length;M++)T+=h[M];const C=p.morphTargetsRelative?1:1-T;m.getUniforms().setValue(r,"morphTargetBaseInfluence",C),m.getUniforms().setValue(r,"morphTargetInfluences",h)}m.getUniforms().setValue(r,"morphTargetsTexture",_.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",_.size)}return{update:c}}function cA(r,e,i,s,l){let c=new WeakMap;function f(h){const v=l.render.frame,S=h.geometry,_=e.get(h,S);if(c.get(_)!==v&&(e.update(_),c.set(_,v)),h.isInstancedMesh&&(h.hasEventListener("dispose",m)===!1&&h.addEventListener("dispose",m),c.get(h)!==v&&(i.update(h.instanceMatrix,r.ARRAY_BUFFER),h.instanceColor!==null&&i.update(h.instanceColor,r.ARRAY_BUFFER),c.set(h,v))),h.isSkinnedMesh){const b=h.skeleton;c.get(b)!==v&&(b.update(),c.set(b,v))}return _}function p(){c=new WeakMap}function m(h){const v=h.target;v.removeEventListener("dispose",m),s.releaseStatesOfObject(v),i.remove(v.instanceMatrix),v.instanceColor!==null&&i.remove(v.instanceColor)}return{update:f,dispose:p}}const uA={[Mx]:"LINEAR_TONE_MAPPING",[bx]:"REINHARD_TONE_MAPPING",[Ex]:"CINEON_TONE_MAPPING",[Tx]:"ACES_FILMIC_TONE_MAPPING",[wx]:"AGX_TONE_MAPPING",[Rx]:"NEUTRAL_TONE_MAPPING",[Ax]:"CUSTOM_TONE_MAPPING"};function fA(r,e,i,s,l){const c=new Ai(e,i,{type:r,depthBuffer:s,stencilBuffer:l}),f=new Ai(e,i,{type:Wi,depthBuffer:!1,stencilBuffer:!1}),p=new Ci;p.setAttribute("position",new Ri([-1,3,0,-1,-1,0,3,-1,0],3)),p.setAttribute("uv",new Ri([0,2,0,0,2,0],2));const m=new Ko({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+y);const N=D+M+f,L=D+y+p,B=jv(l,l.VERTEX_SHADER,N),G=jv(l,l.FRAGMENT_SHADER,L);l.attachShader(C,B),l.attachShader(C,G),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function k(V){if(r.debug.checkShaderErrors){const te=l.getProgramInfoLog(C)||"",se=l.getShaderInfoLog(B)||"",ue=l.getShaderInfoLog(G)||"",Q=te.trim(),I=se.trim(),H=ue.trim();let de=!0,ve=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(de=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,C,B,G);else{const P=Wv(l,B,"vertex"),K=Wv(l,G,"fragment");Rt("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
