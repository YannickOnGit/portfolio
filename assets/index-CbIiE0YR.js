 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var L0;function ZS(){return L0||(L0=1,function(r){function e(I,H){var de=I.length;I.push(H);e:for(;0<de;){var ge=de-1>>>1,O=I[ge];if(0<l(O,H))I[ge]=H,I[de]=O,de=ge;else break e}}function i(I){return I.length===0?null:I[0]}function s(I){if(I.length===0)return null;var H=I[0],de=I.pop();if(de!==H){I[0]=de;e:for(var ge=0,O=I.length,K=O>>>1;ge<K;){var he=2*(ge+1)-1,_e=I[he],Ue=he+1,Ye=I[Ue];if(0>l(_e,de))Ue<O&&0>l(Ye,_e)?(I[ge]=Ye,I[Ue]=de,ge=Ue):(I[ge]=_e,I[he]=de,ge=he);else if(Ue<O&&0>l(Ye,de))I[ge]=Ye,I[Ue]=de,ge=Ue;else break e}}return H}function l(I,H){var de=I.sortIndex-H.sortIndex;return de!==0?de:I.id-H.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,p=f.now();r.unstable_now=function(){return f.now()-p}}var g=[],h=[],x=1,y=null,_=3,E=!1,T=!1,C=!1,S=!1,M=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function U(I){for(var H=i(h);H!==null;){if(H.callback===null)s(h);else if(H.startTime<=I)s(h),H.sortIndex=H.expirationTime,e(g,H);else break;H=i(h)}}function B(I){if(C=!1,U(I),!T)if(i(g)!==null)T=!0,G||(G=!0,te());else{var H=i(h);H!==null&&Q(B,H.startTime-I)}}var G=!1,k=-1,A=5,L=-1;function pe(){return S?!0:!(r.unstable_now()-L<A)}function V(){if(S=!1,G){var I=r.unstable_now();L=I;var H=!0;try{e:{T=!1,C&&(C=!1,N(k),k=-1),E=!0;var de=_;try{t:{for(U(I),y=i(g);y!==null&&!(y.expirationTime>I&&pe());){var ge=y.callback;if(typeof ge=="function"){y.callback=null,_=y.priorityLevel;var O=ge(y.expirationTime<=I);if(I=r.unstable_now(),typeof O=="function"){y.callback=O,U(I),H=!0;break t}y===i(g)&&s(g),U(I)}else s(g);y=i(g)}if(y!==null)H=!0;else{var K=i(h);K!==null&&Q(B,K.startTime-I),H=!1}}break e}finally{y=null,_=de,E=!1}H=void 0}}finally{H?te():G=!1}}}var te;if(typeof P=="function")te=function(){P(V)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,ue=se.port2;se.port1.onmessage=V,te=function(){ue.postMessage(null)}}else te=function(){M(V,0)};function Q(I,H){k=M(function(){I(r.unstable_now())},H)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(I){I.callback=null},r.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<I?Math.floor(1e3/I):5},r.unstable_getCurrentPriorityLevel=function(){return _},r.unstable_next=function(I){switch(_){case 1:case 2:case 3:var H=3;break;default:H=_}var de=_;_=H;try{return I()}finally{_=de}},r.unstable_requestPaint=function(){S=!0},r.unstable_runWithPriority=function(I,H){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var de=_;_=I;try{return H()}finally{_=de}},r.unstable_scheduleCallback=function(I,H,de){var ge=r.unstable_now();switch(typeof de=="object"&&de!==null?(de=de.delay,de=typeof de=="number"&&0<de?ge+de:ge):de=ge,I){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=de+O,I={id:x++,callback:H,priorityLevel:I,startTime:de,expirationTime:O,sortIndex:-1},de>ge?(I.sortIndex=de,e(h,I),i(g)===null&&I===i(h)&&(C?(N(k),k=-1):C=!0,Q(B,de-ge))):(I.sortIndex=O,e(g,I),T||E||(T=!0,G||(G=!0,te()))),I},r.unstable_shouldYield=pe,r.unstable_wrapCallback=function(I){var H=_;return function(){var de=_;_=H;try{return I.apply(this,arguments)}finally{_=de}}}}(dd)),dd}var O0;function KS(){return O0||(O0=1,fd.exports=ZS()),fd.exports}var hd={exports:{}},Cn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var P0;function QS(){if(P0)return Cn;P0=1;var r=Xh();function e(g){var h="https://react.dev/errors/"+g;if(1<arguments.length){h+="?args[]="+encodeURIComponent(arguments[1]);for(var x=2;x<arguments.length;x++)h+="&args[]="+encodeURIComponent(arguments[x])}return"Minified React error #"+g+"; visit "+h+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var s={d:{f:i,r:function(){throw Error(e(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},l=Symbol.for("react.portal");function c(g,h,x){var y=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:l,key:y==null?null:""+y,children:g,containerInfo:h,implementation:x}}var f=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function p(g,h){if(g==="font")return"";if(typeof h=="string")return h==="use-credentials"?h:""}return Cn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Cn.createPortal=function(g,h){var x=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!h||h.nodeType!==1&&h.nodeType!==9&&h.nodeType!==11)throw Error(e(299));return c(g,h,null,x)},Cn.flushSync=function(g){var h=f.T,x=s.p;try{if(f.T=null,s.p=2,g)return g()}finally{f.T=h,s.p=x,s.d.f()}},Cn.preconnect=function(g,h){typeof g=="string"&&(h?(h=h.crossOrigin,h=typeof h=="string"?h==="use-credentials"?h:"":void 0):h=null,s.d.C(g,h))},Cn.prefetchDNS=function(g){typeof g=="string"&&s.d.D(g)},Cn.preinit=function(g,h){if(typeof g=="string"&&h&&typeof h.as=="string"){var x=h.as,y=p(x,h.crossOrigin),_=typeof h.integrity=="string"?h.integrity:void 0,E=typeof h.fetchPriority=="string"?h.fetchPriority:void 0;x==="style"?s.d.S(g,typeof h.precedence=="string"?h.precedence:void 0,{crossOrigin:y,integrity:_,fetchPriority:E}):x==="script"&&s.d.X(g,{crossOrigin:y,integrity:_,fetchPriority:E,nonce:typeof h.nonce=="string"?h.nonce:void 0})}},Cn.preinitModule=function(g,h){if(typeof g=="string")if(typeof h=="object"&&h!==null){if(h.as==null||h.as==="script"){var x=p(h.as,h.crossOrigin);s.d.M(g,{crossOrigin:x,integrity:typeof h.integrity=="string"?h.integrity:void 0,nonce:typeof h.nonce=="string"?h.nonce:void 0})}}else h==null&&s.d.M(g)},Cn.preload=function(g,h){if(typeof g=="string"&&typeof h=="object"&&h!==null&&typeof h.as=="string"){var x=h.as,y=p(x,h.crossOrigin);s.d.L(g,x,{crossOrigin:y,integrity:typeof h.integrity=="string"?h.integrity:void 0,nonce:typeof h.nonce=="string"?h.nonce:void 0,type:typeof h.type=="string"?h.type:void 0,fetchPriority:typeof h.fetchPriority=="string"?h.fetchPriority:void 0,referrerPolicy:typeof h.referrerPolicy=="string"?h.referrerPolicy:void 0,imageSrcSet:typeof h.imageSrcSet=="string"?h.imageSrcSet:void 0,imageSizes:typeof h.imageSizes=="string"?h.imageSizes:void 0,media:typeof h.media=="string"?h.media:void 0})}},Cn.preloadModule=function(g,h){if(typeof g=="string")if(h){var x=p(h.as,h.crossOrigin);s.d.m(g,{as:typeof h.as=="string"&&h.as!=="script"?h.as:void 0,crossOrigin:x,integrity:typeof h.integrity=="string"?h.integrity:void 0})}else s.d.m(g)},Cn.requestFormReset=function(g){s.d.r(g)},Cn.unstable_batchedUpdates=function(g,h){return g(h)},Cn.useFormState=function(g,h,x){return f.H.useFormState(g,h,x)},Cn.useFormStatus=function(){return f.H.useHostTransitionStatus()},Cn.version="19.1.0",Cn}var I0;function Zv(){if(I0)return hd.exports;I0=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(e){console.error(e)}}return r(),hd.exports=QS(),hd.exports}/**
 * @license React
...
`;class Se{constructor(v){var F;this.props=v||{},this.uniforms=(F=this.props.material)==null?void 0:F.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new dv,this.camera=new eu,this.uniforms&&(this.material=new Wo(this.props.material),this.geometry=new Ns(2,2),this.plane=new di(this.geometry,this.material),this.scene.add(this.plane))}update(){ue.renderer.setRenderTarget(this.props.output||null),ue.renderer.render(this.scene,this.camera),ue.renderer.setRenderTarget(null)}}class Je extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:K,uniforms:{boundarySpace:{value:v.cellScale},px:{value:v.cellScale},fboSize:{value:v.fboSize},velocity:{value:v.src.texture},dt:{value:v.dt},isBFECC:{value:!0}}},output:v.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){const v=new Ri,F=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);v.setAttribute("position",new Ai(F,3));const Z=new Wo({vertexShader:ge,fragmentShader:K,uniforms:this.uniforms});this.line=new pb(v,Z),this.scene.add(this.line)}update({dt:v,isBounce:F,BFECC:Z}){this.uniforms.dt.value=v,this.line.visible=F,this.uniforms.isBFECC.value=Z,super.update()}}class Ke extends Se{constructor(v){super({output:v.dst}),this.init(v)}init(v){super.init();const F=new Ns(1,1),Z=new Wo({vertexShader:O,fragmentShader:Ue,blending:Jd,depthWrite:!1,uniforms:{px:{value:v.cellScale},force:{value:new ot(0,0)},center:{value:new ot(0,0)},scale:{value:new ot(v.cursor_size,v.cursor_size)}}});this.mouse=new di(F,Z),this.scene.add(this.mouse)}update(v){const F=I.diff.x/2*v.mouse_force,Z=I.diff.y/2*v.mouse_force,le=v.cursor_size*v.cellScale.x,ae=v.cursor_size*v.cellScale.y,we=Math.min(Math.max(I.coords.x,-1+le+v.cellScale.x*2),1-le-v.cellScale.x*2),Re=Math.min(Math.max(I.coords.y,-1+ae+v.cellScale.y*2),1-ae-v.cellScale.y*2),Xe=this.mouse.material.uniforms;Xe.force.value.set(F,Z),Xe.center.value.set(we,Re),Xe.scale.value.set(v.cursor_size,v.cursor_size),super.update()}}class $e extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:Me,uniforms:{boundarySpace:{value:v.boundarySpace},velocity:{value:v.src.texture},velocity_new:{value:v.dst_.texture},v:{value:v.viscous},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst,output0:v.dst_,output1:v.dst}),this.init()}update({viscous:v,iterations:F,dt:Z}){let le,ae;this.uniforms.v.value=v;for(let we=0;we<F;we++)we%2===0?(le=this.props.output0,ae=this.props.output1):(le=this.props.output1,ae=this.props.output0),this.uniforms.velocity_new.value=le.texture,this.props.output=ae,this.uniforms.dt.value=Z,super.update();return ae}}class qt extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:_e,uniforms:{boundarySpace:{value:v.boundarySpace},velocity:{value:v.src.texture},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst}),this.init()}update({vel:v}){this.uniforms.velocity.value=v.texture,super.update()}}class ht extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:Ye,uniforms:{boundarySpace:{value:v.boundarySpace},pressure:{value:v.dst_.texture},divergence:{value:v.src.texture},px:{value:v.cellScale}}},output:v.dst,output0:v.dst_,output1:v.dst}),this.init()}update({iterations:v}){let F,Z;for(let le=0;le<v;le++)le%2===0?(F=this.props.output0,Z=this.props.output1):(F=this.props.output1,Z=this.props.output0),this.uniforms.pressure.value=F.texture,this.props.output=Z,super.update();return Z}}class _t extends Se{constructor(v){super({material:{vertexShader:de,fragmentShader:ee,uniforms:{boundarySpace:{value:v.boundarySpace},pressure:{value:v.src_p.texture},velocity:{value:v.src_v.texture},px:{value:v.cellScale},dt:{value:v.dt}}},output:v.dst}),this.init()}update({vel:v,pressure:F}){this.uniforms.velocity.value=v.texture,this.uniforms.pressure.value=F.texture,super.update()}}class Ct{constructor(v){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...v},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new ot,this.cellScale=new ot,this.boundarySpace=new ot,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?ki:Ei}createAllFBO(){const F={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:fn,magFilter:fn,wrapS:ei,wrapT:ei};for(let Z in this.fbos)this.fbos[Z]=new Ti(this.fboSize.x,this.fboSize.y,F)}createShaderPass(){this.advection=new Je({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new Ke({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new $e({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new qt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new ht({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new _t({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){const v=Math.max(1,Math.round(this.options.resolution*ue.width)),F=Math.max(1,Math.round(this.options.resolution*ue.height)),Z=1/v,le=1/F;this.cellScale.set(Z,le),this.fboSize.set(v,F)}resize(){this.calcSize();for(let v in this.fbos)this.fbos[v].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let v=this.fbos.vel_1;this.options.isViscous&&(v=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:v});const F=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:v,pressure:F})}}class rt{constructor(){this.init()}init(){this.simulation=new Ct,this.scene=new dv,this.camera=new eu,this.output=new di(new Ns(2,2),new Wo({vertexShader:de,fragmentShader:he,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new ot},palette:{value:V},bgColor:{value:te}}})),this.scene.add(this.output)}addScene(v){this.scene.add(v)}resize(){this.simulation.resize()}render(){ue.renderer.setRenderTarget(null),ue.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class yt{constructor(v){this.props=v,ue.init(v.$wrapper),I.init(v.$wrapper),I.autoIntensity=v.autoIntensity,I.takeoverDuration=v.takeoverDuration,this.lastUserInteraction=performance.now(),I.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new H(I,this,{enabled:v.autoDemo,speed:v.autoSpeed,resumeDelay:v.autoResumeDelay,rampDuration:v.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener("resize",this._resize),this._onVisibility=()=>{document.hidden?this.pause():A.current&&this.start()},document.addEventListener("visibilitychange",this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(ue.renderer.domElement),this.output=new rt}resize(){ue.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),I.update(),ue.update(),this.output.update()}loop(){this.running&&(this.render(),G.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,G.current&&(cancelAnimationFrame(G.current),G.current=null)}dispose(){try{if(window.removeEventListener("resize",this._resize),document.removeEventListener("visibilitychange",this._onVisibility),I.dispose(),ue.renderer){const v=ue.renderer.domElement;v&&v.parentNode&&v.parentNode.removeChild(v),ue.renderer.dispose()}}catch{}}}const j=P.current;j.style.position=j.style.position||"relative",j.style.overflow=j.style.overflow||"hidden";const kt=new yt({$wrapper:j,autoDemo:E,autoSpeed:T,autoIntensity:C,takeoverDuration:S,autoResumeDelay:M,autoRampDuration:N});U.current=kt,(()=>{var F;if(!U.current)return;const D=(F=U.current.output)==null?void 0:F.simulation;if(!D)return;const v=D.options.resolution;Object.assign(D.options,{mouse_force:r,cursor_size:e,isViscous:i,viscous:s,iterations_viscous:l,iterations_poisson:c,dt:f,BFECC:p,resolution:g,isBounce:h}),g!==v&&D.resize()})(),kt.start();const bt=new IntersectionObserver(D=>{const v=D[0],F=v.isIntersecting&&v.intersectionRatio>0;A.current=F,U.current&&(F&&!document.hidden?U.current.start():U.current.pause())},{threshold:[0,.01,.1]});bt.observe(j),k.current=bt;const Ge=new ResizeObserver(()=>{U.current&&(L.current&&cancelAnimationFrame(L.current),L.current=requestAnimationFrame(()=>{U.current&&U.current.resize()}))});return Ge.observe(j),B.current=Ge,()=>{if(G.current&&cancelAnimationFrame(G.current),B.current)try{B.current.disconnect()}catch{}if(k.current)try{k.current.disconnect()}catch{}U.current&&U.current.dispose(),U.current=null}},[p,e,f,h,i,c,l,r,g,s,x,E,T,C,S,M,N]),Ne.useEffect(()=>{var se;const pe=U.current;if(!pe)return;const V=(se=pe.output)==null?void 0:se.simulation;if(!V)return;const te=V.options.resolution;Object.assign(V.options,{mouse_force:r,cursor_size:e,isViscous:i,viscous:s,iterations_viscous:l,iterations_poisson:c,dt:f,BFECC:p,resolution:g,isBounce:h}),pe.autoDriver&&(pe.autoDriver.enabled=E,pe.autoDriver.speed=T,pe.autoDriver.resumeDelay=M,pe.autoDriver.rampDurationMs=N*1e3,pe.autoDriver.mouse&&(pe.autoDriver.mouse.autoIntensity=C,pe.autoDriver.mouse.takeoverDuration=S)),g!==te&&V.resize()},[r,e,i,s,l,c,f,p,g,h,E,T,C,S,M,N]),m.jsx("div",{ref:P,className:`liquid-ether-container ${_||""}`,style:y})}const Nr=({name:r="",size:e=24,color:i="currentColor",strokeColor:s="",className:l=""})=>m.jsx("svg",{className:l,width:e,height:e,fill:i,stroke:s||"currentColor",children:m.jsx("use",{href:`/portfolio/icon-sprite.svg#${r}`})}),Sw=({toggleMenu:r})=>m.jsxs("header",{className:"p-2 bg-stone-800/50 text-white h-14 flex justify-between px-4 w-full","aria-label":"Main navigation",children:[m.jsxs("div",{className:"flex flex-1 items-center align-middle h-full",children:[m.jsx("button",{onClick:r,"aria-label":"Toggle menu",className:"md:hidden",children:m.jsx(Nr,{name:"mobile-menu",size:18,className:" items-center align-middle"})}),m.jsxs(Dr,{to:"/","aria-label":"Go to Home",className:"flex",children:[m.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 40 40",width:"40",height:"40",className:" aspect-square h-6 my-auto",children:[m.jsx("circle",{cx:"20",cy:"20",r:"18",fill:"#FFFFFF"}),m.jsx("path",{d:"M13 11 L18.5 20.5 V29 H21.5 V20.5 L27 11 H23.5 L20 17 L16.5 11 H13 Z",fill:"#1A1D21"})]}),m.jsx("h4",{className:" text-stone-200/80 text-lg my-auto leading-normal mt-0.5",children:"Product Portfolio"})]})]}),m.jsx("div",{className:"flex  space-x-2 justify-end",children:m.jsx("a",{href:"https://www.linkedin.com/in/yannick-boulanger/",target:"_blank",rel:"noopener noreferrer",className:"p-1 rounded-lg items-center border border-gray-600 justify-center transition-all duration-500  hover:border-blue-400 hover:bg-blue-900",children:m.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"28",height:"28",viewBox:"0 0 72 72",fill:"none",children:m.jsx("path",{d:"M24.7612 55.999V28.3354H15.5433V55.999H24.7621H24.7612ZM20.1542 24.5591C23.3679 24.5591 25.3687 22.4348 25.3687 19.7801C25.3086 17.065 23.3679 15 20.2153 15C17.0605 15 15 17.065 15 19.7799C15 22.4346 17.0001 24.5588 20.0938 24.5588H20.1534L20.1542 24.5591ZM29.8633 55.999H39.0805V40.5521C39.0805 39.7264 39.1406 38.8985 39.3841 38.3088C40.0502 36.6562 41.5668 34.9455 44.1138 34.9455C47.4484 34.9455 48.7831 37.4821 48.7831 41.2014V55.999H58V40.1376C58 31.6408 53.4532 27.6869 47.3887 27.6869C42.4167 27.6869 40.233 30.4589 39.0198 32.347H39.0812V28.3364H29.8638C29.9841 30.9316 29.8631 56 29.8631 56L29.8633 55.999Z",fill:"#fff"})})})})]}),yw=()=>{const r=Ps(),[e,i]=Ne.useState(!1),[s,l]=Ne.useState(!1);Ne.useEffect(()=>{i(r.pathname.startsWith("/Case")),l(r.pathname.startsWith("/Portfolio"))},[r.pathname]);const c="hover:bg-stone-800/50 hover:text-stone-200",f="bg-stone-800/50 text-white",g=`text-md text-stone-400 flex flex-row px-0 py-2 pl-6 pr-4 items-center justify-start transition-all duration-300 ease-out ${c} active:bg-purple-700/50`,h=x=>r.pathname===x?f:"";return m.jsx("div",{className:"grow border-r-2 border-stone-800 pt-4",children:m.jsxs("nav",{"aria-label":"Primary Navigation",children:[m.jsxs("ul",{className:"list-none mt-20  space-y-0",children:[m.jsx("li",{className:"-ml-0.5 mb-1",children:m.jsxs(Dr,{to:"/",className:`${g} ${h("/")}`,children:[m.jsx(Nr,{name:"home",size:20,className:"mr-2 -mt-1 text-white"}),m.jsx("span",{className:"text-xl font-normal",children:"Home"})]})}),m.jsxs("li",{className:"-ml-0.5",children:[m.jsxs("button",{onClick:()=>i(x=>!x),className:`${g} w-full`,children:[m.jsx(Nr,{name:"cases",size:20,className:"mr-2 -mt-1 text-white"}),m.jsx("span",{className:"text-xl font-normal",children:"Cases"}),m.jsx(Nr,{name:"chevron-down",size:20,className:`ml-auto transition-transform duration-300 ${e?"rotate-180":""}`})]}),m.jsx("ul",{className:`ml-6 mt-1 space-y-1 empty:hidden list-none overflow-hidden transition-all duration-300 ease-in-out ${e?"max-h-40 opacity-100":"max-h-0 opacity-0"}`,children:["Case01","Case02","Case03"].map(x=>{const y=`/${x}`;return m.jsx("li",{className:"-ml-0.5",children:m.jsx(Dr,{to:y,className:`${g} ${h(y)} ${e?"translate-y-0 opacity-100":"-translate-y-2 opacity-0"}`,children:m.jsx("span",{className:"ml-6 text-xl font-normal",children:x.replace("Case","Case 0")})})},x)})})]}),m.jsxs("li",{className:"-ml-0.5",children:[m.jsxs("button",{onClick:()=>l(x=>!x),className:`${g} w-full`,children:[m.jsx(Nr,{name:"portfolio",size:20,className:"mr-2 -mt-1 text-white"}),m.jsx("span",{className:"text-xl font-normal",children:"Portfolio"}),m.jsx(Nr,{name:"chevron-down",size:20,className:`ml-auto transition-transform duration-300 ${s?"rotate-180":""}`})]}),m.jsx("ul",{className:`ml-6 mt-1  space-y-1 empty:hidden list-none overflow-hidden transition-all duration-300 ease-in-out ${s?"max-h-40 opacity-100":"max-h-0 opacity-0"}`,children:Array.from({length:3}).map((x,y)=>{const _=y+1,E=`/Portfolio0${_}`;return m.jsx("li",{className:"-ml-0.5",children:m.jsx(Dr,{to:E,className:`${g} ${h(E)} ${s?"translate-y-0 opacity-100":"-translate-y-2 opacity-0"}`,children:m.jsxs("span",{className:"ml-6 text-xl font-normal",children:["Project 00",_]})})},E)})})]})]}),m.jsxs("div",{className:"absolute bottom-8 p-6",children:[m.jsxs("div",{className:"flex items-start space-x-1 mx-auto",children:[m.jsx("i",{className:"-ml-1 mr-1.5",children:m.jsx("svg",{width:"24",height:"24",viewBox:"0 2 24 24",fill:"orange",children:m.jsx("path",{d:"M12 2.5L14.9 8.6L21.5 9.4L16.75 13.9L18.1 20.5L12 17.2L5.9 20.5L7.25 13.9L2.5 9.4L9.1 8.6L12 2.5Z"})})}),m.jsx("p",{className:"text-medium leading-snug",children:"Open to New Opportunities"})]}),m.jsx("a",{href:"https://www.linkedin.com/in/yannick-boulanger/",target:"_blank",rel:"noopener noreferrer",className:"bg-stone-800/50 block text-center w-full p-1.5 pb-2 px-3 rounded-lg border border-gray-600 transition-all duration-500 hover:border-purple-300/80 hover:bg-purple-900 text-white",children:"Get in touch!"})]})]})})},Mw="/portfolio/assets/Thumb-Case01-DdFGIIfZ.png",bw="/portfolio/assets/Thumb-Case02-D3YojT8i.png",Ew="/portfolio/assets/Thumb-Case03-DGzPN63w.png",Tw=[{id:1,tag:"Product Case",title:"Interface Redesign",desc:"Multi-Panel Workspace for Sales Workflows",img:Mw,status:"Open",active:!0,path:"Case01"},{id:2,tag:"UX Case",title:"VPN Enrollment Flow",desc:"Self-Service Onboarding & MFA Authentication",img:bw,status:"Open",active:!0,path:"Case02"},{id:3,tag:"Product Case",title:"Dynamic Prioritization",desc:"Flexible Query-Building for Sales Workflows",img:Ew,status:"Open",active:!0,path:"Case03"}];function Aw(){return m.jsxs("section",{className:"mb-16 max-w-screen-lg mx-auto px-6 xl:px-0",children:[m.jsx("h3",{children:"Case Studies"}),m.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:Tw.map(r=>m.jsxs("div",{className:"group bg-stone-800/50 rounded-1xl overflow-hidden hover:shadow-xl hover:bg-stone-800/60  transition-all duration-500 rounded-2xl hover:scale-104",children:[m.jsx("div",{className:"relative aspect-6/4 overflow-hidden bg-stone-600",children:m.jsx("img",{src:r.img,alt:r.title,className:"w-full h-full object-cover object-top transition-all duration-500 group-hover:scale-107"})}),m.jsxs("div",{className:"p-6",children:[m.jsx("h4",{className:"text-2xl font-semibold mb-2",children:r.title}),m.jsx("p",{children:r.desc}),r.active?m.jsx(Dr,{to:`${r.path}`,className:"block w-full  text-center p-2 rounded-lg text-cyan-500 text-lg font-medium transition-all duration-500 bg-stone-950/80 border border-cyan-600 group-hover:bg-cyan-500 group-hover:text-black shadow-indigo-600/40 shadow-2xl",children:r.status}):m.jsx("button",{disabled:!0,className:"w-full p-2 rounded-lg text-cyan-400 text-lg font-medium bg-stone-800/40 border border-transparent cursor-not-allowed",children:r.status})]})]},r.id))})]})}const ww="/portfolio/assets/Thumb-Port01-se4AUbEI.png",Rw="/portfolio/assets/Thumb-Port02-b4ueRP8H.png",Cw="/portfolio/assets/Thumb-Port03-BST0Lm-n.png",Nw=[{id:1,tag:"Portfolio",title:"Secure & Resilient",desc:"Zero-Touch Provisioning For Multi-tenacy",img:Rw,status:"Open",active:!0,path:"Portfolio01"},{id:2,tag:"Portfolio",title:"Hybrid Workforce",desc:"SD-WAN Remote Access for Distributed Teams",img:ww,status:"Open",active:!0,path:"Portfolio02"},{id:3,tag:"Wireframe",title:"Debt Assessment Tool",desc:"Helping Physicians Manage debt smarter",img:Cw,status:"Open",active:!0,path:"Portfolio03"}];function Dw(){return m.jsxs("section",{className:"mb-16 max-w-screen-lg mx-auto  px-6 xl:px-0",children:[m.jsx("h3",{children:"Portfolio"}),m.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:Nw.map(r=>m.jsxs("div",{className:"group bg-stone-800/50 rounded-1xl overflow-hidden hover:shadow-xl hover:bg-stone-800/60 transition-all duration-500 rounded-2xl hover:scale-104",children:[m.jsx("div",{className:"relative aspect-6/4 overflow-hidden bg-stone-600",children:m.jsx("img",{src:r.img,alt:r.title,className:"w-full h-full object-cover object-top  transition-all duration-500 group-hover:scale-107"})}),m.jsxs("div",{className:"p-6",children:[m.jsx("h4",{className:" text-2xl font-semibold mb-1",children:r.title}),m.jsx("p",{children:r.desc}),r.active?m.jsx(Dr,{to:`${r.path}`,className:"block w-full  text-center p-2 rounded-lg text-cyan-500 text-lg font-medium transition-all duration-500 bg-stone-950/80 border border-cyan-600 group-hover:bg-cyan-500 group-hover:text-black shadow-indigo-600/40 shadow-2xl",children:r.status}):m.jsx("button",{disabled:!0,className:"w-full p-2 rounded-lg text-cyan-400 text-lg font-medium bg-stone-800/40 border border-transparent cursor-not-allowed",children:r.status})]})]},r.id))})]})}function Uw(){return m.jsx(m.Fragment,{children:m.jsxs("div",{className:"w-full text-stone-100",children:[m.jsxs("div",{id:"Top",className:"mb-16 max-w-screen-lg mx-auto px-6 xl:px-0",children:[m.jsx("h2",{className:"text-3xl pb-12",children:"Yannick Boulanger"}),m.jsx("h1",{className:"uppercase font-bold",children:"Product Designer"}),m.jsx("h1",{className:"mb-16 font-light uppercase bg-stone-800/50",children:"Solutions for Complex Human Applications"}),m.jsxs("div",{className:"lg:flex flex-wrap gap-12",children:[m.jsxs("div",{className:"flex-1",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Enterprise SaaS Delivery"}),m.jsx("p",{children:"I conceptualize complex SaaS products from discovery through delivery and ground product strategy in user research and real-world workflows."}),m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Cross-Functional Collaboration"}),m.jsx("p",{children:"I collaborate with Product, Engineering, and stakeholders to turn vision into execution, delivering maximum value while making complex systems scalable and user-friendly."})]}),m.jsxs("div",{className:"flex-1",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Structured, Usable Systems"}),m.jsx("p",{children:"I prioritize information architecture, consistency, and usability over visual polish, ensuring highly technical environments remain accessible, secure, and reliable."}),m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Evidence-Based Practice"}),m.jsx("p",{children:"I take an iterative, evidence-based approach, guiding design decisions with data and measuring impact through meaningful user and business outcomes."})]})]})]}),m.jsx(Aw,{}),m.jsx(Dw,{}),m.jsxs("div",{id:"Summary",className:"text-white max-w-screen-lg mx-auto lg:flex flex-wrap mb-12 px-6 xl:px-0",children:[m.jsx("h3",{children:"Summary"}),m.jsxs("div",{className:"lg:flex gap-6",children:[m.jsxs("div",{className:"flex-1",children:[m.jsx("p",{children:"Senior Product Designer with 15+ years of experience leading complex B2B SaaS and enterprise platforms from concept through delivery."}),m.jsx("p",{children:"I combine systems thinking, technical depth, and product strategy to simplify complex environments, from SD-WAN platforms to scalable CRM systems."})]}),m.jsxs("div",{className:"flex-1",children:[m.jsx("p",{children:"I’ve led large-scale UX initiatives that improved revenue performance, increased operational efficiency, and enabled platform scalability."}),m.jsx("p",{children:"I align business goals, architecture, and user needs to deliver secure, intuitive, and resilient product experiences at scale across complex enterprise ecosystems."})]})]})]}),m.jsx("div",{className:"w-full bg-stone-800/20 mb-12 py-12 border-stone-800",children:m.jsxs("div",{className:"max-w-screen-lg mx-auto grid grid-cols-2 lg:grid-cols-4 gap-6 px-6 xl:px-0",children:[m.jsx("div",{className:"flex-1",children:m.jsxs("dl",{children:[m.jsx("dt",{className:"pb-2 text-cyan-300/90 text-3xl",children:"Product"}),m.jsxs("dd",{className:"text-lg text-white",children:["Vision, Strategy ",m.jsx("br",{}),"& Agile Delivery"]})]})}),m.jsx("div",{className:"flex-1",children:m.jsxs("dl",{children:[m.jsx("dt",{className:"pb-2 text-cyan-300/90 text-3xl",children:"UI/UX"}),m.jsx("dd",{className:"text-lg text-white",children:"Visual, Workflow & Interaction Design"})]})}),m.jsx("div",{className:"flex-1",children:m.jsxs("dl",{children:[m.jsx("dt",{className:"pb-2 text-cyan-300/90 text-3xl",children:"SaaS/B2B"}),m.jsxs("dd",{className:"text-lg text-white",children:["Scalable Enterprise ",m.jsx("br",{}),"Platforms"]})]})}),m.jsx("div",{className:"flex-1 rounded-br-lg",children:m.jsxs("dl",{children:[m.jsx("dt",{className:"pb-2 text-cyan-300/90 text-3xl",children:"Front-End"}),m.jsx("dd",{className:"text-lg text-white",children:"Implementation & Accessibility"})]})})]})}),m.jsxs("p",{className:"mt-24 text-center",children:["© ",new Date().getFullYear()," Yannick Boulanger. All rights reserved."]})]})})}function ap({images:r}){const[e,i]=Ne.useState(0),s=()=>i((e-1+r.length)%r.length),l=()=>i((e+1)%r.length);return m.jsx("div",{className:"text-gray-200 bg-zinc-900/50 px-6",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 relative",children:[m.jsxs("div",{className:"relative group overflow-hidden cursor-pointer rounded-xl",children:[m.jsx("img",{src:r[e].src,className:"border-zinc-700 border shadow-2xl mx-auto transition-transform duration-700",alt:r[e].alt}),m.jsx("button",{onClick:s,className:`absolute left-0 top-0 bottom-0 w-20 flex items-center justify-center bg-black/20 
                       opacity-0 group-hover:opacity-100 
                       -translate-x-full group-hover:translate-x-0
                       transition-all duration-500 ease-out will-change-transform`,"aria-label":"Previous slide",children:m.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-10 w-10 text-white drop-shadow-md",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2.5,children:m.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15 19l-7-7 7-7"})})}),m.jsx("button",{onClick:l,className:`absolute right-0 top-0 bottom-0 w-20 flex items-center justify-center bg-black/20 
                       opacity-0 group-hover:opacity-100 
                       translate-x-full group-hover:translate-x-0
                       transition-all duration-500 ease-out will-change-transform`,"aria-label":"Next slide",children:m.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-10 w-10 text-white drop-shadow-md",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2.5,children:m.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M9 5l7 7-7 7"})})})]}),m.jsx("div",{className:"flex justify-center mt-8 space-x-4",children:r.map((c,f)=>m.jsx("button",{className:`h-2 transition-all duration-500 rounded-full ${f===e?"w-8 bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]":"w-2 bg-zinc-600"}`,onClick:()=>i(f)},f))})]})})}const Lw="/portfolio/assets/Case-001-Caller-UI-0ciZWlwv.png",Ow="/portfolio/assets/Case-001-Screen-01-O8so0Rvv.png",Pw="/portfolio/assets/Case-001-Screen-02-DymXWPSn.png",Iw="/portfolio/assets/VS-Old-CallerUI-Dw1hW2WW.png";function Fw(){const r=[{src:Lw,alt:"Final multi-panel workspace integrating CRM, scripts, and communication tools."},{src:Ow,alt:"Multi-panel workspace with integrated SMS communication."},{src:Pw,alt:"Multi-panel workspace with heads-up display (HUD) interface."}];return m.jsxs("div",{children:[m.jsx("div",{className:"w-full px-6 xl:px-0",children:m.jsxs("div",{className:"max-w-screen-lg mx-auto",children:[m.jsx("h2",{className:"text-3xl pb-12",children:"Case 001 : VanillaSoft"}),m.jsx("h1",{className:"uppercase font-bold",children:"Interface Redesign"}),m.jsx("h1",{className:"uppercase mb-12 font-light leading-none bg-stone-800/50",children:"Multi-Panel Workspace for Sales Workflows"}),m.jsxs("div",{className:"lg:flex gap-6 py-6",children:[m.jsxs("div",{className:"flex-1/3 mb-6",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Contributions"}),m.jsxs("ul",{className:"mt-4 space-y-1 text-lg",children:[m.jsx("li",{children:"Contextual & User Research"}),m.jsx("li",{children:"Workflow & Task Analysis"}),m.jsx("li",{children:"Market & Competitor Analysis"}),m.jsx("li",{children:"Information Architecture"}),m.jsx("li",{children:"Interaction Design"}),m.jsx("li",{children:"Product Design & UI/UX"})]})]}),m.jsxs("div",{className:"flex-2/3",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Assignment"}),m.jsx("p",{children:"The objective of this project was to redesign VanillaSoft’s core Caller UI to improve usability, scalability, and overall user satisfaction while modernizing its visual design and aligning it with contemporary interaction standards."}),m.jsx("p",{children:"The new interface was designed to support both novice and experienced users, streamline complex sales workflows, and accommodate a growing user base without compromising performance."}),m.jsx("p",{children:"The redesign focused on improving task efficiency, reducing cognitive load, and providing a flexible, responsive workspace across different devices and screen sizes. I was responsible for research, design, front-end integration, and QA throughout the project lifecycle."})]})]})]})}),m.jsx(ap,{images:r}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Context"})}),m.jsxs("div",{className:"lg:flex  gap-6 flex-3/4",children:[m.jsx("div",{className:"flex-1/2",children:m.jsx("p",{children:"VanillaSoft is a cloud-based sales management platform that integrates CRM, lead management, and telemarketing tools to streamline sales team workflows. It helps organizations manage outreach and customer relationships in a more structured and efficient way."})}),m.jsx("div",{className:"flex-1/2",children:m.jsx("p",{children:"What sets VanillaSoft apart from competitors is its queue-based approach, which routes agents to the next best contact based on available data instead of a traditional list-based system. This prevents agents from cherry-picking contacts and promotes efficiency, enabling faster and more effective workflows."})})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Observation"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("blockquote",{className:"border-l-4 border-teal-300/80 pl-6 italic text-stone-400",children:"The Caller UI, a central part of the platform used during live calls, had become visually and technically outdated. As the product evolved, the interface became increasingly difficult to extend and maintain."}),m.jsx("blockquote",{className:"mt-6 border-l-4 border-teal-300/80 pl-6 italic text-stone-400",children:"Our research revealed that agents relied heavily on the Caller UI to input data but frequently had to switch between multiple tools to access customer information, scripts, and reference documents. This increased cognitive load, slowed workflows, and reduced call quality."}),m.jsx("blockquote",{className:"mt-6 border-l-4 border-teal-300/80 pl-6 italic text-stone-400",children:"Additionally, the interface architecture made it difficult to scale the UI as new features were added. The redesign needed to improve workflow efficiency while supporting the platform’s long-term evolution."})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Research"})}),m.jsxs("div",{className:"lg:flex gap-6 flex-3/4",children:[m.jsxs("div",{className:"flex-1/2",children:[m.jsx("p",{children:"During the research phase, we studied telemarketer workflows and analyzed competitors."}),m.jsx("p",{children:"A key insight came from photos collected by our CEO and sales representatives at customer call centers, which showed that most users rely heavily on external resources to complete their tasks."})]}),m.jsx("div",{className:"flex-1/2",children:m.jsx("p",{children:"This reliance creates inefficiencies through constant context switching and increases cognitive load, ultimately slowing down workflows and reducing overall focus during customer interactions."})})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Hypothesis"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("blockquote",{className:"mb-6 border-l-4 border-teal-300/80 pl-6 italic text-stone-400",children:"If we integrate these external resources directly into the Caller UI, users will experience a more seamless workflow, reduce cognitive load, and complete tasks more efficiently."}),m.jsx("blockquote",{className:" border-l-4 border-teal-300/80 pl-6 italic text-stone-400",children:"Consolidating tools such as customer details, compliance documents, and other essential applications will also generate richer data for the platform’s queue-based routing system, improving overall performance and outcomes."})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Solution"})}),m.jsxs("div",{className:"lg:flex flex-3/4 gap-6",children:[m.jsxs("div",{className:"flex-1/2",children:[m.jsx("p",{children:"The redesign introduced a flexible multi-panel layout to optimize space and support dynamic workflows, which was innovative at the time. The interface adapts to user tasks, offering a personalized and responsive experience."}),m.jsx("p",{children:"The grid layout, implemented using Kendo UI, ensured stability and performance at scale. Additional information for each contact was fetched asynchronously to minimize wait times."})]}),m.jsxs("div",{className:"flex-1/2",children:[m.jsx("p",{children:"Panels could be resized, reorganized, or removed, allowing the workspace to adapt to user workflows. Inline editing including undo functionality was available to most of the content presented with customization options."}),m.jsx("p",{children:"The redesign supported business growth, boosted user retention, and acted as a differentiator in the competitive CRM market, contributing to strong ROI and long-term success."})]})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Feature"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("h4",{className:"text-cyan-300/90",children:"Modular Multi-Panel Layout"}),m.jsx("p",{children:"A flexible grid allowing users to resize, reorganize, or hide panels based on their specific campaign needs."}),m.jsx("h4",{className:"text-cyan-300/90",children:"Technical Scalability"}),m.jsx("p",{children:"Implemented via Kendo UI for responsive, stable performance with asynchronous loading of contact details to maintain user flow."}),m.jsx("h4",{className:"text-cyan-300/90",children:"Deep Integration"}),m.jsx("p",{children:"Embedded APIs for Email, SMS, and Payment tools directly into the workspace to eliminate the need for external applications."})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Outcomes"})}),m.jsxs("div",{className:"lg:flex flex-3/4 gap-6",children:[m.jsxs("div",{className:"flex-1/2",children:[m.jsx("p",{children:"The redesigned Caller UI became a flagship feature of VanillaSoft, improving workflows by consolidating tools and reducing context-switching. An external study showed users experienced a 30%-100% increase in productivity and completed tasks with fewer errors."}),m.jsx("p",{children:"The responsive, customizable interface allowed users to tailor their workspace, increasing satisfaction and reducing cognitive load. User feedback was positive, with VanillaSoft earning 4.7 stars on Capterra and 4.6 stars on G2."})]}),m.jsxs("div",{className:"flex-1/2",children:[m.jsx("p",{children:"To maintain performance during calls, contact information loads first while additional data is retrieved asynchronously in the background."}),m.jsx("p",{children:"Several integrations—including email, SMS, payment processing, and other communication tools—were embedded directly into the workspace, reducing reliance on external applications."})]})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12 bg-stone-800/20 border-stone-800",children:m.jsxs("div",{className:"max-w-screen-lg mx-auto",children:[m.jsx("h3",{className:"mb-8",children:"Results & Business Impact"}),m.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:[m.jsxs("div",{children:[m.jsx("h2",{className:"text-5xl mb-2 text-cyan-300/90 font-medium",children:"30–100%"}),m.jsx("p",{className:"text-lg",children:"Increase in agent productivity across various sales workflows."})]}),m.jsxs("div",{children:[m.jsx("h2",{className:"text-5xl mb-2 text-cyan-300/90 font-medium",children:"4.7/5"}),m.jsx("p",{className:"text-lg",children:"Average user rating on Capterra, citing improved ease of use."})]}),m.jsxs("div",{children:[m.jsx("h2",{className:"text-5xl mb-2 text-cyan-300/90",children:"Reduction"}),m.jsx("p",{className:"text-lg",children:"Reduced cognitive load through workspace customization and workflow enhancement."})]})]}),m.jsx("small",{children:"Source: VanillaSoft"})]})}),m.jsx("div",{className:"w-full py-12 opacity-50 hover:opacity-100 transition-opacity",children:m.jsxs("div",{className:"max-w-screen-lg mx-auto px-6",children:[m.jsx("h3",{className:"text-stone-500 text-xl",children:"Legacy Interface (For Context)"}),m.jsx("img",{src:Iw,alt:"Old VanillaSoft UI"})]})}),m.jsxs("p",{className:"mt-24 text-center",children:["© ",new Date().getFullYear()," Yannick Boulanger. All rights reserved."]})]})}const Bw="/portfolio/assets/Case-001-Screen-Onboarding-Email-3vOk6BRw.png",zw="/portfolio/assets/Case-001-Journey-Map-Eu5Dqes6.png",Hw="/portfolio/assets/Case-001-Flow-Chart-hcLvhB8r.png",Gw="/portfolio/assets/Case-001-User-Activation-Pug4pFg-.png";function Vw(){const r=[{src:Bw,alt:"Onboarding email with account creation link and essential information."},{src:zw,alt:"Journey map illustrating self-service account provisioning."},{src:Hw,alt:"Authentication flow diagram showing access and validation steps."},{src:Gw,alt:"Account activation and password setup screen."}];return m.jsxs("div",{className:"text-white  ",children:[m.jsx("div",{className:"w-full px-6 xl:px-0",children:m.jsxs("div",{className:"max-w-screen-lg mx-auto",children:[m.jsx("h2",{className:"text-3xl pb-12",children:"Case 002 : Efficient Account Provisioning"}),m.jsx("h1",{className:"uppercase font-bold",children:"VPN Enrollment Flow"}),m.jsx("h1",{className:"uppercase mb-12 font-light leading-none bg-stone-800/50",children:"Self-Service Onboarding & MFA Authentication"}),m.jsxs("div",{className:"lg:flex gap-6 py-6",children:[m.jsxs("div",{className:"flex-1/3 mb-6",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Contributions"}),m.jsxs("ul",{className:"space-y-1",children:[m.jsx("li",{children:"Contextual & User Research"}),m.jsx("li",{children:"Workflow & Task Analysis"}),m.jsx("li",{children:"Identity & Access Management (IAM) Strategy"}),m.jsx("li",{children:"Interaction Design & UI/UX"}),m.jsx("li",{children:"Front-End Integration"})]})]}),m.jsxs("div",{className:"flex-2/3",children:[m.jsx("h2",{className:"text-cyan-300/90  font-normal",children:"Assignment"}),m.jsx("p",{children:"The objective of this project was to streamline the MyConnect VPN user onboarding process for partners and tenants, enabling self-service account creation while enhancing security with Multi-Factor Authentication (MFA)."}),m.jsx("p",{children:"The project aimed to reduce friction, minimize manual IT involvement, and provide a scalable onboarding process. Additionally, it sought to integrate security best practices without compromising usability, creating a flexible experience for both novice and experienced users."}),m.jsx("p",{children:"The role encompassed research, workflow analysis, solution architecture, and the implementation of the enrollment flow using Auth0."})]})]})]})}),m.jsx(ap,{images:r}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Context"})}),m.jsxs("div",{className:"flex gap-6 flex-3/4",children:[m.jsx("div",{className:" flex-1/2",children:m.jsx("p",{children:"Adaptiv Networks is a multi-tenant company providing cloud-managed SD-WAN and secure VPN solutions for businesses."})}),m.jsx("div",{className:" flex-1/2",children:m.jsx("p",{children:"Its VPN service ensures secure connectivity for remote employees as part of a larger self-service portal, allowing businesses to manage network users independently while supporting flexibility, scalability, and security."})})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Observation"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("blockquote",{className:"border-l-4 border-teal-300/80 pl-6 italic text-stone-400 text-2xl",children:m.jsx("p",{children:"The existing MyConnect user creation process was manual, which was sufficient for initial testing but became time-consuming and resource-intensive as adoption grew."})}),m.jsx("blockquote",{className:"mt-6 border-l-4 border-teal-300/80 pl-6 italic text-stone-400 text-2xl",children:m.jsx("p",{children:"Partners and tenants were unable to independently onboard users, limiting enthusiasm and adoption. The lack of self-service created bottlenecks for IT teams and hindered operational efficiency."})}),m.jsx("blockquote",{className:"mt-6 border-l-4 border-teal-300/80 pl-6 italic text-stone-400 text-2xl",children:m.jsx("p",{children:"Additionally, Multi-Factor Authentication (MFA) was critical for meeting security and compliance standards but was not yet implemented. The current enrollment process risked being perceived as incomplete or insecure by security-conscious customers."})})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Research"})}),m.jsxs("div",{className:"flex gap-6 flex-3/4",children:[m.jsx("div",{className:" flex-1/2",children:m.jsx("p",{children:"We mapped key user flows, including enrollment, login, password reset, and MFA setup, to identify friction points. Auth0 was selected as the Identity and Access Management (IAM) platform."})}),m.jsx("div",{className:" flex-1/2",children:m.jsx("p",{children:"I conducted a deep dive into its documentation to understand its framework, evaluate potential challenges, and identify opportunities to streamline the user experience while supporting secure authentication workflows."})})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-16 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:" mb-12",children:"Hypothesis"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("blockquote",{className:"mb-6 border-l-4 border-cyan-200/80 pl-6 italic text-stone-400",children:m.jsxs("p",{children:[m.jsx("strong",{className:"",children:"Streamlined Enrollment with Auth0:"})," ","Leveraging Auth0’s functionality would simplify the enrollment process, reduce friction, and improve user satisfaction."]})}),m.jsx("blockquote",{className:"mb-6 border-l-4 border-cyan-200/80 pl-6 italic text-stone-400",children:m.jsxs("p",{children:[m.jsx("strong",{className:"",children:"Clear Exit Paths and Issue Resolution:"})," ","Anticipating and resolving enrollment issues early would prevent users from getting stuck, ensuring smoother completion."]})}),m.jsx("blockquote",{className:"mb-6 border-l-4 border-cyan-200/80 pl-6 italic text-stone-400",children:m.jsxs("p",{children:[m.jsx("strong",{className:"",children:"Optional MFA Implementation:"})," ","Offering MFA as a configurable feature would meet varying security requirements, providing both flexibility and enhanced protection."]})}),m.jsx("blockquote",{className:"border-l-4 border-cyan-200/80 pl-6 italic text-stone-400",children:m.jsxs("p",{children:[m.jsx("strong",{className:"",children:"Recognized risk:"})," MFA introduces additional steps that may frustrate some users."]})})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Solution"})}),m.jsxs("div",{className:"flex gap-6 flex-3/4",children:[m.jsx("div",{className:" flex-1/2",children:m.jsx("p",{children:"Partners and tenants can create a new MyConnect user by submitting the user’s first name, last name, and email. Once the license is deployed, users receive a one-time password via email—eliminating insecure credential delivery."})}),m.jsx("div",{className:"flex-1/2",children:m.jsx("p",{children:"Users click a link to log into the self-service portal, create a secure password, and, if MFA is enabled, complete the additional authentication steps. MFA options include One-Time Code (app-based), Text (SMS), and Email, offering flexibility and accommodating varying security preferences."})})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-16 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"w-full px-6 xl:px-0",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Feature"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("h4",{className:"text-cyan-300/90",children:"Simplified Self-Service Enrollment"}),m.jsx("p",{className:"mb-6",children:"Enables partners and tenants to onboard users independently, reducing IT tickets."}),m.jsx("h4",{className:"text-cyan-300/90",children:"Flexible MFA Options"}),m.jsx("p",{className:"mb-6",children:"Offers SMS, Email, and Authenticator App options to balance security and user convenience."}),m.jsx("h4",{className:"text-cyan-300/90",children:"Secure Credential Delivery"}),m.jsx("p",{children:"Automated one-time password (OTP) delivery via email to eliminate insecure manual credential sharing."}),m.jsx("h4",{className:"text-cyan-300/90",children:"Auth0 Integration"}),m.jsx("p",{children:"Streamlined IAM workflows and scalable identity management."})]})]})})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Outcomes"})}),m.jsxs("div",{className:"flex gap-6 flex-3/4",children:[m.jsxs("div",{className:" flex-1/2",children:[m.jsx("p",{children:"Initial user testing provided valuable insights into the MFA implementation. App-based one-time codes were the most frustrating due to device dependency and QR code setup, occasionally leading to lockouts."}),m.jsx("p",{children:"SMS-based authentication was smooth and intuitive, with minimal complaints, while email verification was convenient and easy to use, though slightly less secure than SMS."})]}),m.jsxs("div",{className:"flex-1/2",children:[m.jsx("p",{children:"These findings highlighted important trade-offs between security and usability."}),m.jsx("p",{children:"Default Auth0 settings did not fully address organizational security requirements, suggesting that future improvements should include penetration testing and a more tailored MFA strategy to optimize both security and user experience."})]})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-16 bg-stone-800/20 border-stone-800",children:m.jsxs("div",{className:"max-w-screen-lg mx-auto",children:[m.jsx("h3",{className:"  mb-8 ",children:"Results & Business Impact"}),m.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[m.jsxs("div",{children:[m.jsx("h4",{className:"text-cyan-300/90",children:"Seamless Onboarding"}),m.jsx("p",{children:"The new self-service enrollment flow reduces reliance on IT teams, removing manual bottlenecks and enabling faster account creation for partners and tenants."})]}),m.jsxs("div",{children:[m.jsx("h4",{className:"text-cyan-300/90",children:"Flexible & Secure MFA"}),m.jsx("p",{children:"Optional MFA provides flexible security and compliance adherence."})]}),m.jsxs("div",{children:[m.jsx("h4",{className:"text-cyan-300/90",children:"Scalable Architecture"}),m.jsxs("p",{children:["The Auth0-based solution provides a foundation that can grow with user adoption, supporting additional tenants and partners without major workflow redesigns."," "]})]}),m.jsxs("div",{children:[m.jsx("h4",{className:"text-cyan-300/90",children:"Improved User Confidence"}),m.jsx("p",{children:"By standardizing credential delivery and providing clear, guided enrollment steps, users experience fewer errors and confusion during onboarding."})]})]})]})}),m.jsxs("p",{className:" mt-24 text-center",children:["© ",new Date().getFullYear()," Yannick Boulanger. All rights reserved."]})]})}const jw="/portfolio/assets/Case-001-Main-Bb5-afll.png",kw="/portfolio/assets/Case-001-Wireframe-A-B5WwIc_s.png",Xw="/portfolio/assets/Case-001-Wireframe-B-CDqVtw2P.png",Ww="/portfolio/assets/Case-001-Wireframe-C-CGX-9ymp.png",qw="/portfolio/assets/Case-001-Wireframe-D-CzbuQvZ3.png";function Yw(){const r=[{src:jw,alt:"Complex Contact priorization query allowing to filter and triage contact to whom"},{src:kw,alt:"UI Compnenets exploded view"},{src:Xw,alt:"Wireframes A"},{src:Ww,alt:"Wireframes B"},{src:qw,alt:"Wireframes c"}];return m.jsxs("div",{className:"text-white",children:[m.jsx("div",{className:"w-full px-6 xl:px-0",children:m.jsxs("div",{className:"max-w-screen-lg mx-auto",children:[m.jsx("h2",{className:"text-3xl pb-12",children:"Case 003 : Intellective Routing"}),m.jsx("h1",{className:"uppercase font-bold",children:"Dynamic Prioritization"}),m.jsx("h1",{className:"uppercase mb-12 font-light leading-none bg-stone-800/50",children:"Flexible Query-Building for Sales Workflows"}),m.jsxs("div",{className:"lg:flex gap-6 py-6",children:[m.jsxs("div",{className:"flex-1/3 mb-6",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Contributions"}),m.jsxs("ul",{className:"mt-4 space-y-1 text-lg text-stone-300",children:[m.jsx("li",{children:"Contextual & User Research"}),m.jsx("li",{children:"Workflow & Task Analysis"}),m.jsx("li",{children:"Technical Research"}),m.jsx("li",{children:"Feasibility Study"}),m.jsx("li",{children:"Feature Architecture & "}),m.jsx("li",{children:"Implementation Guidance"})]})]}),m.jsxs("div",{className:"flex-2/3",children:[m.jsx("h2",{className:"text-cyan-300/90  font-normal",children:"Assignment"}),m.jsx("p",{children:"The objective of this project was to design a flexible contact prioritization system within VanillaSoft that would allow sales teams to focus on the most relevant leads at the optimal time."}),m.jsx("p",{children:"The platform needed to support multiple levels of prioritization, such as P1 and P2, as well as more granular sub-levels like P1a or P1b. In addition to basic prioritization, users required the ability to define custom rules using different data points, including purchase history, engagement levels, and other behavioral indicators."}),m.jsxs("p",{children:[m.jsx("strong",{children:"My role"})," was to research customer needs, evaluate technical constraints, and design an interface capable of managing complex prioritization logic without overwhelming users. The goal was to create a system that remained flexible for advanced use cases while still being approachable for everyday users."]})]})]})]})}),m.jsx(ap,{images:r}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Overview"})}),m.jsxs("div",{className:"flex gap-6 flex-3/4",children:[m.jsxs("div",{className:" flex-1/2",children:[m.jsxs("p",{children:["VanillaSoft is a cloud-based sales management platform that integrates CRM, lead management, and telemarketing tools to support high-volume sales workflows."," "]}),m.jsx("p",{children:"A key differentiator of the platform is its queue-based model, which routes agents to the next best contact using available data points rather than relying on static contact lists. This approach improves operational efficiency by ensuring agents engage with the most relevant leads at the appropriate moment."})]}),m.jsx("div",{className:" flex-1/2",children:m.jsx("p",{children:"Introducing dynamic prioritization required extending this queue logic so that organizations could better control how leads were ranked and distributed to agents based on their own business strategies."})})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{children:"Observation"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("blockquote",{className:"border-l-4 border-teal-300/80 pl-6 italic text-stone-400",children:"Several customers requested the ability to prioritize contacts using multiple levels of importance. Their goal was to focus sales efforts on leads that were more likely to convert while still maintaining visibility over the broader pipeline."}),m.jsx("blockquote",{className:"mt-6 border-l-4 border-teal-300/80 pl-6 italic text-stone-400",children:"At the time, the platform lacked the ability to support this type of dynamic prioritization. Contacts were processed through the queue, but users could not define layered rules based on different attributes or conditions."}),m.jsx("blockquote",{className:"mt-6 border-l-4 border-teal-300/80 pl-6 italic text-stone-400",children:"The challenge was not only technical but also conceptual. Customers needed the flexibility to combine many different data points and conditions, sometimes creating complex scenarios where contacts should be prioritized under certain circumstances and deprioritized under others. At the same time, the interface needed to remain understandable and manageable for sales teams who were not necessarily technical users."})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Research"})}),m.jsxs("div",{className:"flex gap-6 flex-3/4",children:[m.jsx("div",{className:" flex-1/2",children:m.jsx("p",{children:"To understand the scope of the problem, we reviewed customer requests and documented a wide range of prioritization scenarios. These examples revealed that organizations often wanted to combine multiple conditions when determining which leads should be prioritized. In some cases, contacts might need to be prioritized if they met several criteria but deprioritized if another condition was present."})}),m.jsxs("div",{className:" flex-1/2",children:[m.jsx("p",{children:"Because the number of possible combinations was large, we concluded that the safest approach would be to design a framework capable of supporting a wide range of use cases from the start. Restricting the system too early could lead to limitations and future rework as new customer requirements emerged."}),m.jsx("p",{children:"Another important aspect of the research focused on the user interface. The feature needed to present complex rule logic in a way that remained accessible to users while still offering the flexibility required by more advanced workflows."})]})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-16 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:" mb-12",children:"Hypothesis"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("blockquote",{className:"mb-6 border-l-4 border-cyan-200/80 pl-6 italic text-stone-400",children:"We hypothesized that introducing a flexible prioritization system would significantly improve how sales teams manage and engage with leads. By allowing users to define multiple priority levels and apply rules based on relevant data points, agents would be guided toward the most promising opportunities at the right time."}),m.jsx("blockquote",{className:"mb-6 border-l-4 border-cyan-200/80 pl-6 italic text-stone-400",children:"This capability was expected to improve operational efficiency and potentially increase conversion rates by enabling more targeted sales strategies. At the same time, we recognized that a feature of this complexity could introduce usability challenges. Ensuring that the interface remained intuitive and navigable was therefore critical to preventing cognitive overload and encouraging adoption."})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Solution"})}),m.jsxs("div",{className:"flex gap-6 flex-3/4",children:[m.jsxs("div",{className:" flex-1/2",children:[m.jsx("p",{children:"To support dynamic prioritization, a query-building framework was introduced that allowed users to define and manage complex prioritization rules using different types of data."}),m.jsx("p",{children:"The system supports multiple prioritization criteria and enables users to combine conditions using logical operators such as AND and OR. This makes it possible to create layered rules that reflect the realities of sales workflows, where decisions are often based on several data points rather than a single attribute."})]}),m.jsxs("div",{className:"flex-1/2",children:[m.jsx("p",{children:"Users can also define priority levels such as P1 or P2 and extend them with sub-levels when additional granularity is required. This allows organizations to structure their lead prioritization in a way that reflects their own business processes."}),m.jsx("p",{children:"A significant focus was placed on keeping the interface approachable despite the flexibility of the system. Visual guidance, tooltips, and a structured workflow help users build prioritization rules step by step, reducing the risk of confusion while still supporting advanced configurations."})]})]})]})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-16 bg-stone-800/20 border-stone-800",children:m.jsx("div",{className:"w-full px-6 xl:px-0",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Feature"})}),m.jsxs("div",{className:"flex-3/4",children:[m.jsx("h4",{className:"text-cyan-300/90",children:"Multi‑Criteria Prioritization"}),m.jsx("p",{children:"Users can define rules based on numerous data attributes such as engagement, behavior, and historical performance."}),m.jsx("h4",{className:"text-cyan-300/90",children:"Flexible Rule Logic"}),m.jsx("p",{children:"Support for logical operators and layered conditions allows the construction of nuanced prioritization strategies without coding."}),m.jsx("h4",{className:"text-cyan-300/90",children:"Custom Priority Levels"}),m.jsx("p",{children:"Priority groups and sub‑levels give organizations the flexibility to represent their sales logic structurally."}),m.jsx("h4",{className:"text-cyan-300/90",children:"Guided Rule Builder UI"}),m.jsx("p",{children:"Visual cues and structured workflows make rule building understandable and accessible, reducing cognitive overload."})]})]})})})}),m.jsx("div",{className:"w-full px-6 xl:px-0 py-12",children:m.jsx("div",{className:"max-w-screen-lg mx-auto",children:m.jsxs("div",{className:"lg:flex",children:[m.jsx("div",{className:"flex-1/4",children:m.jsx("h3",{className:"",children:"Outcomes"})}),m.jsxs("div",{className:"flex gap-6 flex-3/4",children:[m.jsx("div",{className:" flex-1/2",children:m.jsx("p",{children:"The prioritization framework introduced a new level of flexibility in how sales teams manage their lead queues. Instead of relying on static prioritization rules, organizations can now adapt their strategies based on the data available in their CRM."})}),m.jsx("div",{className:"flex-1/2",children:m.jsx("p",{children:"Initial feedback indicated that users appreciated the increased visibility into prioritization logic and the ability to refine how leads were distributed to agents. The system also reduced the need for manual lead management, allowing teams to focus more directly on sales activities."})})]})]})})}),m.jsx("div",{className:"w-full bg-stone-800/20 py-20 border-stone-800",children:m.jsxs("div",{className:"max-w-screen-lg mx-auto px-6 xl:px-0",children:[m.jsx("h3",{className:"  mb-8 ",children:"Results & Business Impact"}),m.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-12",children:[m.jsxs("div",{children:[m.jsx("h2",{className:"text-6xl mb-2 text-cyan-300/90",children:"+20%"}),m.jsx("p",{children:"Increase in dials"})]}),m.jsxs("div",{children:[m.jsx("h2",{className:"text-6xl mb-2 text-cyan-300/90",children:"+22%"}),m.jsx("p",{children:"Increase in conversions"})]}),m.jsxs("div",{children:[m.jsx("h2",{className:"text-6xl mb-2 text-cyan-300/90",children:"-40%"}),m.jsx("p",{children:"Decrease in negative dispositions"})]}),m.jsxs("div",{children:[m.jsx("h2",{className:"text-6xl mb-2 text-cyan-300/90",children:"+28%"}),m.jsx("p",{children:"Increase in sales"})]})]}),m.jsx("small",{children:"Source: VanillaSoft"})]})}),m.jsxs("p",{className:" mt-24 text-center",children:["© ",new Date().getFullYear()," Yannick Boulanger. All rights reserved."]})]})}const Zw="/portfolio/assets/SDWAN-Dashboard-Bk5a96ak.png",Kw="/portfolio/assets/SDWAN-Customer%20Inventory-D2RJIWV8.png",Qw="/portfolio/assets/SDWAN-Add%20Site%20and%20Device%20Dialogs-QtfcWiUb.png",Jw="/portfolio/assets/SDWAN-Sites%20and%20Devices%20Management-BRuBVUDL.png",$w="/portfolio/assets/SDWAN-Site%20Dashboard-DZDi9BWm.png",e2="/portfolio/assets/SDWAN-LAN%20Configuration-BA02YH_L.png",t2="/portfolio/assets/SDWAN-Add%20SNAT%20and%20DNAT%20Dialogs-tNtNpK4U.png",n2="/portfolio/assets/SDWAN-Site%20Architecture-Uam3CbTc.png";function i2(){return m.jsxs("div",{className:"text-white",children:[m.jsx("div",{className:"w-full text-gray-200",children:m.jsxs("div",{className:"mb-16 max-w-screen-lg mx-auto text-white px-6 xl:px-0",children:[m.jsx("h2",{className:"text-3xl pb-12 ",children:"Project 001 : SD-WAN Orchestrator"}),m.jsx("h1",{className:"uppercase leading-none font-bold",children:"Secure & Resilient"}),m.jsx("h1",{className:"uppercase mb-16 leading-none   text-white  bg-stone-800/50",children:"Zero-Touch Provisioning For Multi-tenacy"}),m.jsxs("div",{className:"lg:flex gap-6",children:[m.jsxs("div",{className:"flex-1/3  mb-6",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Contributions"}),m.jsxs("ul",{className:"mt-4 space-y-1 text-lg text-zinc-300",children:[m.jsx("li",{children:"Information Architecture"}),m.jsx("li",{children:"Systems Thinking"}),m.jsx("li",{children:"Product Design"}),m.jsx("li",{children:"Design System"}),m.jsx("li",{children:"Data Visualization"})]})]}),m.jsxs("div",{className:"flex-2/3",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Assignment"}),m.jsx("p",{children:"Design and enhance a multi-tenant SD-WAN Orchestrator to provide secure, scalable, and intuitive network management. Focus on end-to-end workflows including zero-touch provisioning, device onboarding, policy configuration, and monitoring. Ensure the platform supports advanced features like SD-WAN, Zero Trust Network Access (ZTNA), Firewall as a Service (FWaaS), and Secure Web Gateway (SWG), while maintaining usability, system observability, and seamless session continuity for enterprise users."})]})]})]})}),m.jsx("div",{className:"text-gray-200  bg-zinc-900/50",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:Zw,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 ",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:Kw,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200  bg-zinc-900/50",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:Qw,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 ",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:Jw,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200  bg-zinc-900/50",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:$w,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 ",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:e2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200  bg-zinc-900/50",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:t2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 ",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:n2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsxs("p",{className:" mt-24 text-center",children:["© ",new Date().getFullYear()," Yannick Boulanger. All rights reserved."]})]})}const a2="/portfolio/assets/AN-MyConnect-01-0_0oPeOX.png",s2="/portfolio/assets/AN-MyConnect-02-Eg7xtiMR.png",r2="/portfolio/assets/AN-MyConnect-03-CbEAz5qL.png",o2="/portfolio/assets/AN-MyConnect-04-BDLs-YlV.png";function l2(){return m.jsxs("div",{className:"text-white",children:[m.jsx("div",{className:"w-full text-gray-200",children:m.jsxs("div",{className:"mb-16 max-w-screen-lg mx-auto text-white  px-6 xl:px-0",children:[m.jsx("h2",{className:"text-3xl pb-12 ",children:"Project 002 : My Connect - Adaptiv Networks"}),m.jsx("h1",{className:"uppercase   leading-none font-bold",children:"Hybrid Workforce"}),m.jsx("h1",{className:"uppercase mb-16 leading-none   text-white  bg-stone-800/50",children:"SD-WAN Remote Access for Distributed Teams"}),m.jsxs("div",{className:"md:flex gap-6",children:[m.jsxs("div",{className:"flex-1/3  mb-6",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Contributions"}),m.jsxs("ul",{className:"mt-4 space-y-1 text-lg text-zinc-300",children:[m.jsx("li",{children:"Visual Design"}),m.jsx("li",{children:"UI/UX Design"}),m.jsx("li",{children:"Authentication"}),m.jsx("li",{children:"Observability"})]})]}),m.jsxs("div",{className:"flex-2/3",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Assignment"}),m.jsxs("p",{children:["Visual redesign of the My Connect client app to improve usability and clarity while enabling secure remote access for distributed teams. Covered the full access lifecycle, including enrollment, authentication, and session continuity, with integrated observability to track user flows and system performance. The client supported multiple platforms, including mobile and desktop."," "]})]})]})]})}),m.jsx("div",{className:"text-gray-200 border-y border-zinc-800 bg-zinc-900/50",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:a2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 border-y border-zinc-800",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:s2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 border-y border-zinc-800 bg-zinc-900/50",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:r2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 border-y border-zinc-800 ",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:o2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsxs("p",{className:" mt-24 text-center",children:["© ",new Date().getFullYear()," Yannick Boulanger. All rights reserved."]})]})}const c2="/portfolio/assets/DAT-Step%2001-BJNi5Ocy.png",u2="/portfolio/assets/DAT-Step%2002-Q4RaQXnV.png",f2="/portfolio/assets/DAT-Step%2003-CaI53oNd.png";function d2(){return m.jsxs("div",{children:[m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"mb-16 max-w-screen-lg mx-auto text-white px-6 xl:px-0",children:[m.jsx("h2",{className:"text-3xl pb-12 ",children:"Project 003 : MD Physicians"}),m.jsx("h1",{className:"uppercase  leading-none font-semibold",children:"Debt Assessment Tool"}),m.jsx("h1",{className:"uppercase mb-16 leading-none   text-white  bg-stone-800/50",children:"Helping Physicians Manage debt smarter"}),m.jsxs("div",{className:"md:flex gap-6",children:[m.jsxs("div",{className:"flex-1/3 mb-6",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Contributions"}),m.jsxs("ul",{className:"mt-4 space-y-1 text-lg",children:[m.jsx("li",{children:"Information Architecture"}),m.jsx("li",{children:"UX Strategy"}),m.jsx("li",{children:"Interaction Logic"}),m.jsx("li",{children:"Marketing"}),m.jsx("li",{children:"Lead Generation"})]})]}),m.jsxs("div",{className:"flex-2/3",children:[m.jsx("h2",{className:"text-cyan-300/90 font-normal",children:"Assignment"}),m.jsxs("p",{children:["Designed and implemented a multi-vector financial modeling engine for MD Financial. The tool translates complex user requirements—including diverse income streams, asset portfolios, and debt obligations—into a unified cash flow analysis. This approach enables physicians to simulate multiple financial scenarios and visualize their long-term effects on liquidity and retirement readiness."," "]})," "]})]})]})}),m.jsx("div",{className:"text-gray-200 border-y border-zinc-800 bg-stone-900/50",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:c2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 border-y border-zinc-800",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:u2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsx("div",{className:"text-gray-200 border-y border-zinc-800 bg-stone-900/50",children:m.jsx("div",{className:"w-full",children:m.jsxs("div",{className:"max-w-screen-xl mx-auto py-16 px-6 xl:px-0",children:[m.jsx("img",{src:f2,className:"border-zinc-700 border shadow-2xl",alt:""}),m.jsx("p",{className:"mt-4 italic text-center"})]})})}),m.jsxs("p",{className:" mt-24 text-center",children:["© ",new Date().getFullYear()," Yannick Boulanger. All rights reserved."]})]})}function h2(){return m.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-top text-stone-100 mt-12 px-6 ",children:[m.jsx("h1",{className:"text-purple-400/80 md:text-6xl mb-4 text-center",children:"Coming Soon — Resume"}),m.jsx("p",{className:"text-center text-stone-200 mb-8",children:"Exciting things are on the way. Stay tuned!"})]})}function p2(){return m.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-top mt-12 px-6 ",children:[m.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-4 text-center",children:"¯\\_(ツ)_/¯"}),m.jsx("h1",{className:"text-3xl md:text-4xl font-bold mt-4 mb-4 text-center",children:"Sorry, this page will be updated soon"}),m.jsxs("p",{className:"text-stone-200 text-sm mt-8 text-center",children:["© ",new Date().getFullYear()," Yannick Boulanger. All rights reserved."]})]})}function m2(){const[r,e]=Ne.useState(window.innerWidth>=768),[i,s]=Ne.useState(window.innerWidth<768),l=Ne.useRef(null),c=Ps();rM(l);const f=()=>e(p=>!p);return Ne.useEffect(()=>{const p=()=>{const g=window.innerWidth<768;s(g),e(!g)};return window.addEventListener("resize",p),p(),()=>window.removeEventListener("resize",p)},[]),Ne.useEffect(()=>{i&&e(!1)},[c.pathname,i]),m.jsxs(m.Fragment,{children:[m.jsx(_w,{className:"bg-stone-950"}),m.jsxs("div",{className:"flex flex-col h-screen w-screen",children:[m.jsx(Sw,{toggleMenu:f}),m.jsxs("div",{className:"flex flex-1 overflow-hidden relative",children:[m.jsx("aside",{className:`w-56 h-full overflow-y-auto flex flex-col transition-all duration-300 
              ${r?"ml-0":"-ml-56"} top-0 left-0 z-40 relative`,children:m.jsx(yw,{})}),r&&i&&m.jsx("div",{onClick:()=>e(!1),className:"fixed inset-0 z-30",style:{backgroundColor:"rgba(0, 0, 0, 0.3)"}}),m.jsx("main",{ref:l,className:"flex-1 overflow-y-auto overscroll-contain ml-0 py-24",children:m.jsxs(Zy,{children:[m.jsx(zi,{path:"/",element:m.jsx(Uw,{})}),m.jsx(zi,{path:"/case01",element:m.jsx(Fw,{})}),m.jsx(zi,{path:"/case02",element:m.jsx(Vw,{})}),m.jsx(zi,{path:"/case03",element:m.jsx(Yw,{})}),m.jsx(zi,{path:"/portfolio01",element:m.jsx(i2,{})}),m.jsx(zi,{path:"/portfolio02",element:m.jsx(l2,{})}),m.jsx(zi,{path:"/portfolio03",element:m.jsx(d2,{})}),m.jsx(zi,{path:"/resume",element:m.jsx(h2,{})}),m.jsx(zi,{path:"/contact",element:m.jsx(p2,{})})]})})]})]})]})}ty.createRoot(document.getElementById("root")).render(m.jsx(Yv.StrictMode,{children:m.jsx(nM,{children:m.jsx(m2,{})})}));
